/**
 * Global Sanctions Entity Profile #7
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord7 {
  profileId: string;
...
export class SanctionProfileMatcher7 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord7): number {
