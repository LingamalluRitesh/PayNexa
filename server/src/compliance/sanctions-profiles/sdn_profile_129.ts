/**
 * Global Sanctions Entity Profile #129
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord129 {
  profileId: string;
...
export class SanctionProfileMatcher129 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord129): number {
