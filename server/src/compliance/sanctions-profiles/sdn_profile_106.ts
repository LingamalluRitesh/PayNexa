/**
 * Global Sanctions Entity Profile #106
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord106 {
  profileId: string;
...
export class SanctionProfileMatcher106 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord106): number {
