/**
 * Global Sanctions Entity Profile #156
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord156 {
  profileId: string;
...
export class SanctionProfileMatcher156 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord156): number {
