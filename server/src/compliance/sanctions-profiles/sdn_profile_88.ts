/**
 * Global Sanctions Entity Profile #88
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord88 {
  profileId: string;
...
export class SanctionProfileMatcher88 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord88): number {
