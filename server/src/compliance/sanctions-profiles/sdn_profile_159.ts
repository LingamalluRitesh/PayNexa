/**
 * Global Sanctions Entity Profile #159
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord159 {
  profileId: string;
...
export class SanctionProfileMatcher159 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord159): number {
