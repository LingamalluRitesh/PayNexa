/**
 * Global Sanctions Entity Profile #112
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord112 {
  profileId: string;
...
export class SanctionProfileMatcher112 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord112): number {
