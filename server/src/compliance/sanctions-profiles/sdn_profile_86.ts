/**
 * Global Sanctions Entity Profile #86
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord86 {
  profileId: string;
...
export class SanctionProfileMatcher86 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord86): number {
