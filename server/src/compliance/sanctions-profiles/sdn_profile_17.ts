/**
 * Global Sanctions Entity Profile #17
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord17 {
  profileId: string;
...
export class SanctionProfileMatcher17 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord17): number {
