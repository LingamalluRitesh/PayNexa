/**
 * Global Sanctions Entity Profile #147
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord147 {
  profileId: string;
...
export class SanctionProfileMatcher147 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord147): number {
