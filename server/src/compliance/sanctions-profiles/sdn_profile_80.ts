/**
 * Global Sanctions Entity Profile #80
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord80 {
  profileId: string;
...
export class SanctionProfileMatcher80 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord80): number {
