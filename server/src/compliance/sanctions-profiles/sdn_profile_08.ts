/**
 * Global Sanctions Entity Profile #8
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord8 {
  profileId: string;
...
export class SanctionProfileMatcher8 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord8): number {
