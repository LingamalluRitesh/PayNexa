/**
 * Global Sanctions Entity Profile #63
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord63 {
  profileId: string;
...
export class SanctionProfileMatcher63 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord63): number {
