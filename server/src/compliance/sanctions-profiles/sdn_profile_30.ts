/**
 * Global Sanctions Entity Profile #30
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord30 {
  profileId: string;
...
export class SanctionProfileMatcher30 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord30): number {
