/**
 * Global Sanctions Entity Profile #38
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord38 {
  profileId: string;
...
export class SanctionProfileMatcher38 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord38): number {
