/**
 * Global Sanctions Entity Profile #179
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord179 {
  profileId: string;
...
export class SanctionProfileMatcher179 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord179): number {
