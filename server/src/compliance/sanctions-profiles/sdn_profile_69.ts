/**
 * Global Sanctions Entity Profile #69
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord69 {
  profileId: string;
...
export class SanctionProfileMatcher69 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord69): number {
