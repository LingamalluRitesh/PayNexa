/**
 * Global Sanctions Entity Profile #34
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord34 {
  profileId: string;
...
export class SanctionProfileMatcher34 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord34): number {
