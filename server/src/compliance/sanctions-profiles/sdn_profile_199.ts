/**
 * Global Sanctions Entity Profile #199
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord199 {
  profileId: string;
...
export class SanctionProfileMatcher199 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord199): number {
