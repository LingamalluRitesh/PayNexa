/**
 * Global Sanctions Entity Profile #177
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord177 {
  profileId: string;
...
export class SanctionProfileMatcher177 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord177): number {
