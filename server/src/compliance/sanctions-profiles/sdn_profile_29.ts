/**
 * Global Sanctions Entity Profile #29
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord29 {
  profileId: string;
...
export class SanctionProfileMatcher29 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord29): number {
