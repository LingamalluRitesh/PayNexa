/**
 * Global Sanctions Entity Profile #66
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord66 {
  profileId: string;
...
export class SanctionProfileMatcher66 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord66): number {
