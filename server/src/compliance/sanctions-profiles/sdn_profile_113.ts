/**
 * Global Sanctions Entity Profile #113
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord113 {
  profileId: string;
...
export class SanctionProfileMatcher113 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord113): number {
