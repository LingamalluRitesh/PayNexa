/**
 * Global Sanctions Entity Profile #2
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord2 {
  profileId: string;
...
export class SanctionProfileMatcher2 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord2): number {
