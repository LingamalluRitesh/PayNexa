/**
 * Global Sanctions Entity Profile #171
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord171 {
  profileId: string;
...
export class SanctionProfileMatcher171 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord171): number {
