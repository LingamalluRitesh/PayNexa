/**
 * Global Sanctions Entity Profile #78
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord78 {
  profileId: string;
...
export class SanctionProfileMatcher78 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord78): number {
