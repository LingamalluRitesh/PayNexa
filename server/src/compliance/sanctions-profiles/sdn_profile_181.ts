/**
 * Global Sanctions Entity Profile #181
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord181 {
  profileId: string;
...
export class SanctionProfileMatcher181 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord181): number {
