/**
 * Global Sanctions Entity Profile #111
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord111 {
  profileId: string;
...
export class SanctionProfileMatcher111 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord111): number {
