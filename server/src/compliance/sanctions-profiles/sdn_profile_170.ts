/**
 * Global Sanctions Entity Profile #170
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord170 {
  profileId: string;
...
export class SanctionProfileMatcher170 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord170): number {
