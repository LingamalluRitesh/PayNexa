/**
 * Global Sanctions Entity Profile #68
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord68 {
  profileId: string;
...
export class SanctionProfileMatcher68 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord68): number {
