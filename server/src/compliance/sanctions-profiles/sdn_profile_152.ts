/**
 * Global Sanctions Entity Profile #152
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord152 {
  profileId: string;
...
export class SanctionProfileMatcher152 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord152): number {
