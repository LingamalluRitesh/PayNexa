/**
 * Global Sanctions Entity Profile #81
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord81 {
  profileId: string;
...
export class SanctionProfileMatcher81 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord81): number {
