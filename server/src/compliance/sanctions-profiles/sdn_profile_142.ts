/**
 * Global Sanctions Entity Profile #142
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord142 {
  profileId: string;
...
export class SanctionProfileMatcher142 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord142): number {
