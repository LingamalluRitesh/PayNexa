/**
 * Global Sanctions Entity Profile #105
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord105 {
  profileId: string;
...
export class SanctionProfileMatcher105 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord105): number {
