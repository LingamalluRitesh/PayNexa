/**
 * Global Sanctions Entity Profile #149
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord149 {
  profileId: string;
...
export class SanctionProfileMatcher149 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord149): number {
