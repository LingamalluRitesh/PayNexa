/**
 * Global Sanctions Entity Profile #168
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord168 {
  profileId: string;
...
export class SanctionProfileMatcher168 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord168): number {
