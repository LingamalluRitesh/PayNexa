/**
 * Global Sanctions Entity Profile #33
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord33 {
  profileId: string;
...
export class SanctionProfileMatcher33 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord33): number {
