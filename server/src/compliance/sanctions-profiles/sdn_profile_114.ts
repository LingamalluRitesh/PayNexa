/**
 * Global Sanctions Entity Profile #114
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord114 {
  profileId: string;
...
export class SanctionProfileMatcher114 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord114): number {
