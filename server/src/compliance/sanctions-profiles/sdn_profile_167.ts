/**
 * Global Sanctions Entity Profile #167
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord167 {
  profileId: string;
...
export class SanctionProfileMatcher167 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord167): number {
