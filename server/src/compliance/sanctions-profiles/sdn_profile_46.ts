/**
 * Global Sanctions Entity Profile #46
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord46 {
  profileId: string;
...
export class SanctionProfileMatcher46 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord46): number {
