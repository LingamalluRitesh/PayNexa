/**
 * Global Sanctions Entity Profile #83
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord83 {
  profileId: string;
...
export class SanctionProfileMatcher83 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord83): number {
