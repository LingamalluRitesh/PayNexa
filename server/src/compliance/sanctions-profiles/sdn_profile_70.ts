/**
 * Global Sanctions Entity Profile #70
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord70 {
  profileId: string;
...
export class SanctionProfileMatcher70 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord70): number {
