/**
 * Global Sanctions Entity Profile #157
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord157 {
  profileId: string;
...
export class SanctionProfileMatcher157 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord157): number {
