/**
 * Global Sanctions Entity Profile #145
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord145 {
  profileId: string;
...
export class SanctionProfileMatcher145 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord145): number {
