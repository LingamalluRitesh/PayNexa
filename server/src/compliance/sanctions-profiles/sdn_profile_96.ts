/**
 * Global Sanctions Entity Profile #96
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord96 {
  profileId: string;
...
export class SanctionProfileMatcher96 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord96): number {
