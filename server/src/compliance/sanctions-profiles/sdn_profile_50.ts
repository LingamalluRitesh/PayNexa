/**
 * Global Sanctions Entity Profile #50
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord50 {
  profileId: string;
...
export class SanctionProfileMatcher50 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord50): number {
