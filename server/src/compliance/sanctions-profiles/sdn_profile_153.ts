/**
 * Global Sanctions Entity Profile #153
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord153 {
  profileId: string;
...
export class SanctionProfileMatcher153 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord153): number {
