/**
 * Global Sanctions Entity Profile #189
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord189 {
  profileId: string;
...
export class SanctionProfileMatcher189 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord189): number {
