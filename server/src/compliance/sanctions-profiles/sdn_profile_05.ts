/**
 * Global Sanctions Entity Profile #5
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord5 {
  profileId: string;
...
export class SanctionProfileMatcher5 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord5): number {
