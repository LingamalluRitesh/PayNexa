/**
 * Global Sanctions Entity Profile #15
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord15 {
  profileId: string;
...
export class SanctionProfileMatcher15 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord15): number {
