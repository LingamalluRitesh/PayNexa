/**
 * Global Sanctions Entity Profile #161
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord161 {
  profileId: string;
...
export class SanctionProfileMatcher161 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord161): number {
