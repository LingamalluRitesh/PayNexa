/**
 * Global Sanctions Entity Profile #44
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord44 {
  profileId: string;
...
export class SanctionProfileMatcher44 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord44): number {
