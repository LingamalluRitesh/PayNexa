/**
 * Global Sanctions Entity Profile #101
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord101 {
  profileId: string;
...
export class SanctionProfileMatcher101 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord101): number {
