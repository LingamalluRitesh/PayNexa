/**
 * Global Sanctions Entity Profile #200
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord200 {
  profileId: string;
...
export class SanctionProfileMatcher200 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord200): number {
