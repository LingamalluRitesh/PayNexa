/**
 * Global Sanctions Entity Profile #118
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord118 {
  profileId: string;
...
export class SanctionProfileMatcher118 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord118): number {
