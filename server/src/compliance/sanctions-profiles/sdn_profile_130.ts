/**
 * Global Sanctions Entity Profile #130
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord130 {
  profileId: string;
...
export class SanctionProfileMatcher130 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord130): number {
