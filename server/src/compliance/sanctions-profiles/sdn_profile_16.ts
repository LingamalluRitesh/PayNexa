/**
 * Global Sanctions Entity Profile #16
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord16 {
  profileId: string;
...
export class SanctionProfileMatcher16 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord16): number {
