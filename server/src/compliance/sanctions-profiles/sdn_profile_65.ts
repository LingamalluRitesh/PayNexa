/**
 * Global Sanctions Entity Profile #65
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord65 {
  profileId: string;
...
export class SanctionProfileMatcher65 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord65): number {
