/**
 * Global Sanctions Entity Profile #198
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord198 {
  profileId: string;
...
export class SanctionProfileMatcher198 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord198): number {
