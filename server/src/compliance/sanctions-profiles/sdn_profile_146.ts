/**
 * Global Sanctions Entity Profile #146
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord146 {
  profileId: string;
...
export class SanctionProfileMatcher146 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord146): number {
