/**
 * Global Sanctions Entity Profile #97
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord97 {
  profileId: string;
...
export class SanctionProfileMatcher97 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord97): number {
