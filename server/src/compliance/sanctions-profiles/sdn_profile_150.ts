/**
 * Global Sanctions Entity Profile #150
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord150 {
  profileId: string;
...
export class SanctionProfileMatcher150 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord150): number {
