/**
 * Global Sanctions Entity Profile #126
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord126 {
  profileId: string;
...
export class SanctionProfileMatcher126 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord126): number {
