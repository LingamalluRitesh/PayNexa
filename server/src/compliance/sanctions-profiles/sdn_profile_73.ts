/**
 * Global Sanctions Entity Profile #73
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord73 {
  profileId: string;
...
export class SanctionProfileMatcher73 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord73): number {
