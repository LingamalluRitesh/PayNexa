/**
 * Global Sanctions Entity Profile #21
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord21 {
  profileId: string;
...
export class SanctionProfileMatcher21 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord21): number {
