/**
 * Global Sanctions Entity Profile #174
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord174 {
  profileId: string;
...
export class SanctionProfileMatcher174 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord174): number {
