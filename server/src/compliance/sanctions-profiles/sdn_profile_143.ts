/**
 * Global Sanctions Entity Profile #143
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord143 {
  profileId: string;
...
export class SanctionProfileMatcher143 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord143): number {
