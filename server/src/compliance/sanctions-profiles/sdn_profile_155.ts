/**
 * Global Sanctions Entity Profile #155
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord155 {
  profileId: string;
...
export class SanctionProfileMatcher155 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord155): number {
