/**
 * Global Sanctions Entity Profile #102
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord102 {
  profileId: string;
...
export class SanctionProfileMatcher102 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord102): number {
