/**
 * Global Sanctions Entity Profile #98
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord98 {
  profileId: string;
...
export class SanctionProfileMatcher98 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord98): number {
