/**
 * Global Sanctions Entity Profile #140
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord140 {
  profileId: string;
...
export class SanctionProfileMatcher140 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord140): number {
