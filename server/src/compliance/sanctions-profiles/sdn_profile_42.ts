/**
 * Global Sanctions Entity Profile #42
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord42 {
  profileId: string;
...
export class SanctionProfileMatcher42 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord42): number {
