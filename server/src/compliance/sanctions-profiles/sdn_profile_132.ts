/**
 * Global Sanctions Entity Profile #132
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord132 {
  profileId: string;
...
export class SanctionProfileMatcher132 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord132): number {
