/**
 * Global Sanctions Entity Profile #54
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord54 {
  profileId: string;
...
export class SanctionProfileMatcher54 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord54): number {
