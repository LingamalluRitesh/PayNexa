/**
 * Global Sanctions Entity Profile #9
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord9 {
  profileId: string;
...
export class SanctionProfileMatcher9 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord9): number {
