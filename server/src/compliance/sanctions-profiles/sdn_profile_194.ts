/**
 * Global Sanctions Entity Profile #194
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord194 {
  profileId: string;
...
export class SanctionProfileMatcher194 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord194): number {
