/**
 * Global Sanctions Entity Profile #116
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord116 {
  profileId: string;
...
export class SanctionProfileMatcher116 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord116): number {
