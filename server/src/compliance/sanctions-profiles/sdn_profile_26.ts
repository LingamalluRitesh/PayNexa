/**
 * Global Sanctions Entity Profile #26
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord26 {
  profileId: string;
...
export class SanctionProfileMatcher26 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord26): number {
