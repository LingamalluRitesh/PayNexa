/**
 * Global Sanctions Entity Profile #169
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord169 {
  profileId: string;
...
export class SanctionProfileMatcher169 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord169): number {
