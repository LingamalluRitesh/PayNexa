/**
 * Global Sanctions Entity Profile #40
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord40 {
  profileId: string;
...
export class SanctionProfileMatcher40 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord40): number {
