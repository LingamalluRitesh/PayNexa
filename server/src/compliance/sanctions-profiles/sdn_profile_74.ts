/**
 * Global Sanctions Entity Profile #74
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord74 {
  profileId: string;
...
export class SanctionProfileMatcher74 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord74): number {
