/**
 * Global Sanctions Entity Profile #19
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord19 {
  profileId: string;
...
export class SanctionProfileMatcher19 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord19): number {
