/**
 * Global Sanctions Entity Profile #160
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord160 {
  profileId: string;
...
export class SanctionProfileMatcher160 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord160): number {
