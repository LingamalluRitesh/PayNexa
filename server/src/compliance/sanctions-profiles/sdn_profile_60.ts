/**
 * Global Sanctions Entity Profile #60
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord60 {
  profileId: string;
...
export class SanctionProfileMatcher60 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord60): number {
