/**
 * Global Sanctions Entity Profile #178
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord178 {
  profileId: string;
...
export class SanctionProfileMatcher178 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord178): number {
