/**
 * Global Sanctions Entity Profile #164
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord164 {
  profileId: string;
...
export class SanctionProfileMatcher164 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord164): number {
