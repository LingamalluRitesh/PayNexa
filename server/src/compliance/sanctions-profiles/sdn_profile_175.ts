/**
 * Global Sanctions Entity Profile #175
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord175 {
  profileId: string;
...
export class SanctionProfileMatcher175 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord175): number {
