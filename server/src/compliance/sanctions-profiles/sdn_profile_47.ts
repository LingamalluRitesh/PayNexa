/**
 * Global Sanctions Entity Profile #47
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord47 {
  profileId: string;
...
export class SanctionProfileMatcher47 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord47): number {
