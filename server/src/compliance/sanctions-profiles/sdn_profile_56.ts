/**
 * Global Sanctions Entity Profile #56
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord56 {
  profileId: string;
...
export class SanctionProfileMatcher56 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord56): number {
