/**
 * Global Sanctions Entity Profile #61
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord61 {
  profileId: string;
...
export class SanctionProfileMatcher61 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord61): number {
