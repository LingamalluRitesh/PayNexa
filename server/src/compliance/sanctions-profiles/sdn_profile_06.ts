/**
 * Global Sanctions Entity Profile #6
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord6 {
  profileId: string;
...
export class SanctionProfileMatcher6 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord6): number {
