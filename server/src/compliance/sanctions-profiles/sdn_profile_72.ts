/**
 * Global Sanctions Entity Profile #72
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord72 {
  profileId: string;
...
export class SanctionProfileMatcher72 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord72): number {
