/**
 * Global Sanctions Entity Profile #124
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord124 {
  profileId: string;
...
export class SanctionProfileMatcher124 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord124): number {
