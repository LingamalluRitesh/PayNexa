/**
 * Global Sanctions Entity Profile #23
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord23 {
  profileId: string;
...
export class SanctionProfileMatcher23 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord23): number {
