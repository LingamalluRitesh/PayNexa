/**
 * Global Sanctions Entity Profile #144
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord144 {
  profileId: string;
...
export class SanctionProfileMatcher144 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord144): number {
