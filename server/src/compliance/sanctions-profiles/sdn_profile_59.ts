/**
 * Global Sanctions Entity Profile #59
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord59 {
  profileId: string;
...
export class SanctionProfileMatcher59 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord59): number {
