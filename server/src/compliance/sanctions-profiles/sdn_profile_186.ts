/**
 * Global Sanctions Entity Profile #186
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord186 {
  profileId: string;
...
export class SanctionProfileMatcher186 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord186): number {
