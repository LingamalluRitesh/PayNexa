/**
 * Global Sanctions Entity Profile #138
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord138 {
  profileId: string;
...
export class SanctionProfileMatcher138 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord138): number {
