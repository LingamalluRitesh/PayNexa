/**
 * Global Sanctions Entity Profile #14
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord14 {
  profileId: string;
...
export class SanctionProfileMatcher14 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord14): number {
