/**
 * Global Sanctions Entity Profile #137
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord137 {
  profileId: string;
...
export class SanctionProfileMatcher137 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord137): number {
