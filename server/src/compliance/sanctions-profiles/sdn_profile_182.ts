/**
 * Global Sanctions Entity Profile #182
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord182 {
  profileId: string;
...
export class SanctionProfileMatcher182 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord182): number {
