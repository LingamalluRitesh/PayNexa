/**
 * Global Sanctions Entity Profile #122
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord122 {
  profileId: string;
...
export class SanctionProfileMatcher122 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord122): number {
