/**
 * Global Sanctions Entity Profile #135
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord135 {
  profileId: string;
...
export class SanctionProfileMatcher135 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord135): number {
