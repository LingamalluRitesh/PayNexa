/**
 * Global Sanctions Entity Profile #85
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord85 {
  profileId: string;
...
export class SanctionProfileMatcher85 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord85): number {
