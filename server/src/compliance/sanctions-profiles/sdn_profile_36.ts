/**
 * Global Sanctions Entity Profile #36
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord36 {
  profileId: string;
...
export class SanctionProfileMatcher36 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord36): number {
