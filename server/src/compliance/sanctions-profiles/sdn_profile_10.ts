/**
 * Global Sanctions Entity Profile #10
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord10 {
  profileId: string;
...
export class SanctionProfileMatcher10 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord10): number {
