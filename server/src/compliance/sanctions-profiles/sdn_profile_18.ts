/**
 * Global Sanctions Entity Profile #18
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord18 {
  profileId: string;
...
export class SanctionProfileMatcher18 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord18): number {
