/**
 * Global Sanctions Entity Profile #108
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord108 {
  profileId: string;
...
export class SanctionProfileMatcher108 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord108): number {
