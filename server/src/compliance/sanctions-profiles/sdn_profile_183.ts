/**
 * Global Sanctions Entity Profile #183
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord183 {
  profileId: string;
...
export class SanctionProfileMatcher183 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord183): number {
