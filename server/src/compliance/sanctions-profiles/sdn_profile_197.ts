/**
 * Global Sanctions Entity Profile #197
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord197 {
  profileId: string;
...
export class SanctionProfileMatcher197 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord197): number {
