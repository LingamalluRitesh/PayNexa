/**
 * Global Sanctions Entity Profile #43
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord43 {
  profileId: string;
...
export class SanctionProfileMatcher43 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord43): number {
