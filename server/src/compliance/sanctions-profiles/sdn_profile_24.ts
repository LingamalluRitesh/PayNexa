/**
 * Global Sanctions Entity Profile #24
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord24 {
  profileId: string;
...
export class SanctionProfileMatcher24 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord24): number {
