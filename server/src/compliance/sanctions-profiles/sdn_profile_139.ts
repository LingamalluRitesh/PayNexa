/**
 * Global Sanctions Entity Profile #139
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord139 {
  profileId: string;
...
export class SanctionProfileMatcher139 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord139): number {
