/**
 * Global Sanctions Entity Profile #94
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord94 {
  profileId: string;
...
export class SanctionProfileMatcher94 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord94): number {
