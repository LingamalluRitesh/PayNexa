/**
 * Global Sanctions Entity Profile #82
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord82 {
  profileId: string;
...
export class SanctionProfileMatcher82 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord82): number {
