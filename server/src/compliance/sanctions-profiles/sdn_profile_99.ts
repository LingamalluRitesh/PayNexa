/**
 * Global Sanctions Entity Profile #99
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord99 {
  profileId: string;
...
export class SanctionProfileMatcher99 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord99): number {
