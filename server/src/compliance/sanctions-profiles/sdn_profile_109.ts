/**
 * Global Sanctions Entity Profile #109
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord109 {
  profileId: string;
...
export class SanctionProfileMatcher109 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord109): number {
