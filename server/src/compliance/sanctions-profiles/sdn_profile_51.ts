/**
 * Global Sanctions Entity Profile #51
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord51 {
  profileId: string;
...
export class SanctionProfileMatcher51 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord51): number {
