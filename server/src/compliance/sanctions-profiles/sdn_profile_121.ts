/**
 * Global Sanctions Entity Profile #121
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord121 {
  profileId: string;
...
export class SanctionProfileMatcher121 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord121): number {
