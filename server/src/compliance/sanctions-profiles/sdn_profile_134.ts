/**
 * Global Sanctions Entity Profile #134
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord134 {
  profileId: string;
...
export class SanctionProfileMatcher134 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord134): number {
