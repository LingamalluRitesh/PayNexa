/**
 * Global Sanctions Entity Profile #127
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord127 {
  profileId: string;
...
export class SanctionProfileMatcher127 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord127): number {
