/**
 * Global Sanctions Entity Profile #20
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord20 {
  profileId: string;
...
export class SanctionProfileMatcher20 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord20): number {
