/**
 * Global Sanctions Entity Profile #163
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord163 {
  profileId: string;
...
export class SanctionProfileMatcher163 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord163): number {
