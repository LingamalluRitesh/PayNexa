/**
 * Global Sanctions Entity Profile #162
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord162 {
  profileId: string;
...
export class SanctionProfileMatcher162 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord162): number {
