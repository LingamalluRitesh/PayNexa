/**
 * Global Sanctions Entity Profile #39
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord39 {
  profileId: string;
...
export class SanctionProfileMatcher39 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord39): number {
