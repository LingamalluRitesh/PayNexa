/**
 * Global Sanctions Entity Profile #110
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord110 {
  profileId: string;
...
export class SanctionProfileMatcher110 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord110): number {
