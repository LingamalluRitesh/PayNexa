/**
 * Global Sanctions Entity Profile #1
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord1 {
  profileId: string;
...
export class SanctionProfileMatcher1 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord1): number {
