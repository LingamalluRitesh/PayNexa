/**
 * Global Sanctions Entity Profile #49
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord49 {
  profileId: string;
...
export class SanctionProfileMatcher49 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord49): number {
