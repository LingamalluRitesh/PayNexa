/**
 * Global Sanctions Entity Profile #3
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord3 {
  profileId: string;
...
export class SanctionProfileMatcher3 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord3): number {
