/**
 * Global Sanctions Entity Profile #89
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord89 {
  profileId: string;
...
export class SanctionProfileMatcher89 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord89): number {
