/**
 * Global Sanctions Entity Profile #58
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord58 {
  profileId: string;
...
export class SanctionProfileMatcher58 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord58): number {
