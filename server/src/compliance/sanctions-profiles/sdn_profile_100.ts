/**
 * Global Sanctions Entity Profile #100
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord100 {
  profileId: string;
...
export class SanctionProfileMatcher100 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord100): number {
