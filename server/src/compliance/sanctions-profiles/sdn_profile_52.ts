/**
 * Global Sanctions Entity Profile #52
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord52 {
  profileId: string;
...
export class SanctionProfileMatcher52 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord52): number {
