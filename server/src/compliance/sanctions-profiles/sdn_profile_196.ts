/**
 * Global Sanctions Entity Profile #196
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord196 {
  profileId: string;
...
export class SanctionProfileMatcher196 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord196): number {
