/**
 * Global Sanctions Entity Profile #32
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord32 {
  profileId: string;
...
export class SanctionProfileMatcher32 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord32): number {
