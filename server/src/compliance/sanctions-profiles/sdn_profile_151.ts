/**
 * Global Sanctions Entity Profile #151
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord151 {
  profileId: string;
...
export class SanctionProfileMatcher151 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord151): number {
