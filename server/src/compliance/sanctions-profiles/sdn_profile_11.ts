/**
 * Global Sanctions Entity Profile #11
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord11 {
  profileId: string;
...
export class SanctionProfileMatcher11 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord11): number {
