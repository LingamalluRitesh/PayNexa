/**
 * Global Sanctions Entity Profile #195
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord195 {
  profileId: string;
...
export class SanctionProfileMatcher195 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord195): number {
