/**
 * Global Sanctions Entity Profile #184
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord184 {
  profileId: string;
...
export class SanctionProfileMatcher184 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord184): number {
