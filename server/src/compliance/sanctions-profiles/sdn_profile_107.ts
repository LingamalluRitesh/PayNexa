/**
 * Global Sanctions Entity Profile #107
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord107 {
  profileId: string;
...
export class SanctionProfileMatcher107 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord107): number {
