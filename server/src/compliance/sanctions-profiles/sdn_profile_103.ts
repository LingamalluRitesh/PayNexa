/**
 * Global Sanctions Entity Profile #103
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord103 {
  profileId: string;
...
export class SanctionProfileMatcher103 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord103): number {
