/**
 * Global Sanctions Entity Profile #125
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord125 {
  profileId: string;
...
export class SanctionProfileMatcher125 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord125): number {
