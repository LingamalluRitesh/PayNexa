/**
 * Global Sanctions Entity Profile #76
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord76 {
  profileId: string;
...
export class SanctionProfileMatcher76 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord76): number {
