/**
 * Global Sanctions Entity Profile #166
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord166 {
  profileId: string;
...
export class SanctionProfileMatcher166 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord166): number {
