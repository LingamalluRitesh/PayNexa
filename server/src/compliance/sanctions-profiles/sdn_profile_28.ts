/**
 * Global Sanctions Entity Profile #28
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord28 {
  profileId: string;
...
export class SanctionProfileMatcher28 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord28): number {
