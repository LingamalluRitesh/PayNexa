/**
 * Global Sanctions Entity Profile #92
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord92 {
  profileId: string;
...
export class SanctionProfileMatcher92 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord92): number {
