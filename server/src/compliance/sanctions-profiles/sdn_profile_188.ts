/**
 * Global Sanctions Entity Profile #188
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord188 {
  profileId: string;
...
export class SanctionProfileMatcher188 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord188): number {
