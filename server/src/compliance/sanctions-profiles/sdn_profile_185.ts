/**
 * Global Sanctions Entity Profile #185
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord185 {
  profileId: string;
...
export class SanctionProfileMatcher185 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord185): number {
