/**
 * Global Sanctions Entity Profile #172
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord172 {
  profileId: string;
...
export class SanctionProfileMatcher172 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord172): number {
