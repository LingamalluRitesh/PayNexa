/**
 * Global Sanctions Entity Profile #77
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord77 {
  profileId: string;
...
export class SanctionProfileMatcher77 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord77): number {
