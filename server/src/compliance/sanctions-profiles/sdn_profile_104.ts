/**
 * Global Sanctions Entity Profile #104
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord104 {
  profileId: string;
...
export class SanctionProfileMatcher104 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord104): number {
