/**
 * Global Sanctions Entity Profile #45
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord45 {
  profileId: string;
...
export class SanctionProfileMatcher45 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord45): number {
