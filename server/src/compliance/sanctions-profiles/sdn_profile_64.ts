/**
 * Global Sanctions Entity Profile #64
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord64 {
  profileId: string;
...
export class SanctionProfileMatcher64 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord64): number {
