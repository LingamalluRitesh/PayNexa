/**
 * Global Sanctions Entity Profile #22
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord22 {
  profileId: string;
...
export class SanctionProfileMatcher22 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord22): number {
