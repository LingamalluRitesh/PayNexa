/**
 * Global Sanctions Entity Profile #62
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord62 {
  profileId: string;
...
export class SanctionProfileMatcher62 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord62): number {
