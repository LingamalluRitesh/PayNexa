/**
 * Global Sanctions Entity Profile #41
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord41 {
  profileId: string;
...
export class SanctionProfileMatcher41 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord41): number {
