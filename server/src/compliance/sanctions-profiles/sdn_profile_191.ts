/**
 * Global Sanctions Entity Profile #191
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord191 {
  profileId: string;
...
export class SanctionProfileMatcher191 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord191): number {
