/**
 * Global Sanctions Entity Profile #193
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord193 {
  profileId: string;
...
export class SanctionProfileMatcher193 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord193): number {
