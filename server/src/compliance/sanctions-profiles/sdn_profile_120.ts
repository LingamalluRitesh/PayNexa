/**
 * Global Sanctions Entity Profile #120
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord120 {
  profileId: string;
...
export class SanctionProfileMatcher120 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord120): number {
