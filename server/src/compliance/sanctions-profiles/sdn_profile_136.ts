/**
 * Global Sanctions Entity Profile #136
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord136 {
  profileId: string;
...
export class SanctionProfileMatcher136 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord136): number {
