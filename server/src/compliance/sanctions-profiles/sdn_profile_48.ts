/**
 * Global Sanctions Entity Profile #48
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord48 {
  profileId: string;
...
export class SanctionProfileMatcher48 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord48): number {
