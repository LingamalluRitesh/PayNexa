/**
 * Global Sanctions Entity Profile #131
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord131 {
  profileId: string;
...
export class SanctionProfileMatcher131 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord131): number {
