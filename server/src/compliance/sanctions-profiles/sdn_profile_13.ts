/**
 * Global Sanctions Entity Profile #13
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord13 {
  profileId: string;
...
export class SanctionProfileMatcher13 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord13): number {
