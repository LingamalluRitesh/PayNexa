/**
 * Global Sanctions Entity Profile #12
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord12 {
  profileId: string;
...
export class SanctionProfileMatcher12 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord12): number {
