/**
 * Global Sanctions Entity Profile #117
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord117 {
  profileId: string;
...
export class SanctionProfileMatcher117 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord117): number {
