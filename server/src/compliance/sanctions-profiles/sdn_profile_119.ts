/**
 * Global Sanctions Entity Profile #119
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord119 {
  profileId: string;
...
export class SanctionProfileMatcher119 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord119): number {
