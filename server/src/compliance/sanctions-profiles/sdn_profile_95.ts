/**
 * Global Sanctions Entity Profile #95
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord95 {
  profileId: string;
...
export class SanctionProfileMatcher95 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord95): number {
