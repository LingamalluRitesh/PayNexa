/**
 * Global Sanctions Entity Profile #31
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord31 {
  profileId: string;
...
export class SanctionProfileMatcher31 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord31): number {
