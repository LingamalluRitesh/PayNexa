/**
 * Global Sanctions Entity Profile #165
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord165 {
  profileId: string;
...
export class SanctionProfileMatcher165 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord165): number {
