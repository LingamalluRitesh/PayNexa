/**
 * Global Sanctions Entity Profile #25
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord25 {
  profileId: string;
...
export class SanctionProfileMatcher25 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord25): number {
