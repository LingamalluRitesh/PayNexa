/**
 * Global Sanctions Entity Profile #123
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord123 {
  profileId: string;
...
export class SanctionProfileMatcher123 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord123): number {
