/**
 * Global Sanctions Entity Profile #187
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord187 {
  profileId: string;
...
export class SanctionProfileMatcher187 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord187): number {
