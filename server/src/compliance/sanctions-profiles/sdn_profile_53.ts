/**
 * Global Sanctions Entity Profile #53
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord53 {
  profileId: string;
...
export class SanctionProfileMatcher53 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord53): number {
