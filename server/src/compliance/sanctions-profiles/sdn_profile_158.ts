/**
 * Global Sanctions Entity Profile #158
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord158 {
  profileId: string;
...
export class SanctionProfileMatcher158 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord158): number {
