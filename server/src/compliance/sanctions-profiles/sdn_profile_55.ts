/**
 * Global Sanctions Entity Profile #55
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord55 {
  profileId: string;
...
export class SanctionProfileMatcher55 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord55): number {
