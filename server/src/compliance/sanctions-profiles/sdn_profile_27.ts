/**
 * Global Sanctions Entity Profile #27
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord27 {
  profileId: string;
...
export class SanctionProfileMatcher27 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord27): number {
