/**
 * Global Sanctions Entity Profile #180
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord180 {
  profileId: string;
...
export class SanctionProfileMatcher180 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord180): number {
