/**
 * Global Sanctions Entity Profile #4
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord4 {
  profileId: string;
...
export class SanctionProfileMatcher4 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord4): number {
