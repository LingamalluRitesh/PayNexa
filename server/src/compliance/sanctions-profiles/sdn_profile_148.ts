/**
 * Global Sanctions Entity Profile #148
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord148 {
  profileId: string;
...
export class SanctionProfileMatcher148 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord148): number {
