/**
 * Global Sanctions Entity Profile #91
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord91 {
  profileId: string;
...
export class SanctionProfileMatcher91 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord91): number {
