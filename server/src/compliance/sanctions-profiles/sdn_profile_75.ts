/**
 * Global Sanctions Entity Profile #75
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord75 {
  profileId: string;
...
export class SanctionProfileMatcher75 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord75): number {
