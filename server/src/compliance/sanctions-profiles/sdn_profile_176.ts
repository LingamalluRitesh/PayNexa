/**
 * Global Sanctions Entity Profile #176
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord176 {
  profileId: string;
...
export class SanctionProfileMatcher176 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord176): number {
