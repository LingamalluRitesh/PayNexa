/**
 * Global Sanctions Entity Profile #192
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord192 {
  profileId: string;
...
export class SanctionProfileMatcher192 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord192): number {
