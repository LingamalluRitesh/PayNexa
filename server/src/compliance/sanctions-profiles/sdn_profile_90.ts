/**
 * Global Sanctions Entity Profile #90
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord90 {
  profileId: string;
...
export class SanctionProfileMatcher90 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord90): number {
