/**
 * Global Sanctions Entity Profile #190
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord190 {
  profileId: string;
...
export class SanctionProfileMatcher190 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord190): number {
