/**
 * Global Sanctions Entity Profile #57
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord57 {
  profileId: string;
...
export class SanctionProfileMatcher57 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord57): number {
