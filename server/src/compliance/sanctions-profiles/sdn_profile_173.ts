/**
 * Global Sanctions Entity Profile #173
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord173 {
  profileId: string;
...
export class SanctionProfileMatcher173 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord173): number {
