/**
 * Global Sanctions Entity Profile #128
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord128 {
  profileId: string;
...
export class SanctionProfileMatcher128 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord128): number {
