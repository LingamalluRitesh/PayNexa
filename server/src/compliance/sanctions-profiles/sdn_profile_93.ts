/**
 * Global Sanctions Entity Profile #93
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord93 {
  profileId: string;
...
export class SanctionProfileMatcher93 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord93): number {
