/**
 * Global Sanctions Entity Profile #67
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord67 {
  profileId: string;
...
export class SanctionProfileMatcher67 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord67): number {
