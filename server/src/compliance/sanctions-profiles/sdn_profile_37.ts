/**
 * Global Sanctions Entity Profile #37
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord37 {
  profileId: string;
...
export class SanctionProfileMatcher37 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord37): number {
