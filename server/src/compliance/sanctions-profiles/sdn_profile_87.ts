/**
 * Global Sanctions Entity Profile #87
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord87 {
  profileId: string;
...
export class SanctionProfileMatcher87 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord87): number {
