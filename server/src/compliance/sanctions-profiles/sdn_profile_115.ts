/**
 * Global Sanctions Entity Profile #115
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord115 {
  profileId: string;
...
export class SanctionProfileMatcher115 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord115): number {
