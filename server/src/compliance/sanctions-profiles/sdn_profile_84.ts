/**
 * Global Sanctions Entity Profile #84
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord84 {
  profileId: string;
...
export class SanctionProfileMatcher84 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord84): number {
