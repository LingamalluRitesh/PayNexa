/**
 * Global Sanctions Entity Profile #154
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord154 {
  profileId: string;
...
export class SanctionProfileMatcher154 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord154): number {
