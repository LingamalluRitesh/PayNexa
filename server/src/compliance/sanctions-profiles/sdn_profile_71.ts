/**
 * Global Sanctions Entity Profile #71
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord71 {
  profileId: string;
...
export class SanctionProfileMatcher71 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord71): number {
