/**
 * Global Sanctions Entity Profile #79
 * Source Authority: OFAC / EU / UK HMT / UN Consolidated Sanctions Database
 */

export interface SanctionEntityRecord79 {
  profileId: string;
...
export class SanctionProfileMatcher79 {
  public static evaluateMatch(targetName: string, candidate: SanctionEntityRecord79): number {
