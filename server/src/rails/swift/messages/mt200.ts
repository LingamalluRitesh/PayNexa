/**
 * SWIFT FIN Message Standard: MT200FinancialInstitutionOwnAccount
 * Description: Financial Institution Transfer for Own Account between accounts
 * Compliant with SWIFT Standards Release 2026
 */

export interface MT200FinancialInstitutionOwnAccountFields {
...
export class MT200FinancialInstitutionOwnAccountParser {
  public static parse(rawSwiftBlock: string): Partial<MT200FinancialInstitutionOwnAccountFields> {
    const lines = rawSwiftBlock.split(/\r?\n/);
    const result: Partial<MT200FinancialInstitutionOwnAccountFields> = {};
  ...
  public static format(data: MT200FinancialInstitutionOwnAccountFields): string {
