/**
 * SWIFT FIN Message Standard: MT950StatementMessage
 * Description: Financial Institution Statement Message
 * Compliant with SWIFT Standards Release 2026
 */

export interface MT950StatementMessageFields {
...
export class MT950StatementMessageParser {
  public static parse(rawSwiftBlock: string): Partial<MT950StatementMessageFields> {
    const lines = rawSwiftBlock.split(/\r?\n/);
    const result: Partial<MT950StatementMessageFields> = {};
  ...
  public static format(data: MT950StatementMessageFields): string {
