/**
 * SWIFT FIN Message Standard: MT101RequestForTransfer
 * Description: Request for Transfer message between corporate customer and ordering institution
 * Compliant with SWIFT Standards Release 2026
 */

export interface MT101RequestForTransferFields {
...
export class MT101RequestForTransferParser {
  public static parse(rawSwiftBlock: string): Partial<MT101RequestForTransferFields> {
    const lines = rawSwiftBlock.split(/\r?\n/);
    const result: Partial<MT101RequestForTransferFields> = {};
  ...
  public static format(data: MT101RequestForTransferFields): string {
