/**
 * SWIFT FIN Message Standard: MT900ConfirmationOfDebit
 * Description: Real-time Confirmation of Debit to account owner
 * Compliant with SWIFT Standards Release 2026
 */

export interface MT900ConfirmationOfDebitFields {
...
export class MT900ConfirmationOfDebitParser {
  public static parse(rawSwiftBlock: string): Partial<MT900ConfirmationOfDebitFields> {
    const lines = rawSwiftBlock.split(/\r?\n/);
    const result: Partial<MT900ConfirmationOfDebitFields> = {};
  ...
  public static format(data: MT900ConfirmationOfDebitFields): string {
