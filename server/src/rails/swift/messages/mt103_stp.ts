/**
 * SWIFT FIN Message Standard: MT103StraightThroughProcessing
 * Description: Straight-Through Processing variant of single customer credit transfer
 * Compliant with SWIFT Standards Release 2026
 */

export interface MT103StraightThroughProcessingFields {
...
export class MT103StraightThroughProcessingParser {
  public static parse(rawSwiftBlock: string): Partial<MT103StraightThroughProcessingFields> {
    const lines = rawSwiftBlock.split(/\r?\n/);
    const result: Partial<MT103StraightThroughProcessingFields> = {};
  ...
  public static format(data: MT103StraightThroughProcessingFields): string {
