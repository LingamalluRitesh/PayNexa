/**
 * SWIFT FIN Message Standard: MT999FreeFormatMessage
 * Description: Free Format Narrative Message between institutions
 * Compliant with SWIFT Standards Release 2026
 */

export interface MT999FreeFormatMessageFields {
...
export class MT999FreeFormatMessageParser {
  public static parse(rawSwiftBlock: string): Partial<MT999FreeFormatMessageFields> {
    const lines = rawSwiftBlock.split(/\r?\n/);
    const result: Partial<MT999FreeFormatMessageFields> = {};
  ...
  public static format(data: MT999FreeFormatMessageFields): string {
