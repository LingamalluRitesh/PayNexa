/**
 * SWIFT FIN Message Standard: MT103ExtendedRemittanceInformation
 * Description: Customer Credit Transfer with 9,000-character extended remittance data
 * Compliant with SWIFT Standards Release 2026
 */

export interface MT103ExtendedRemittanceInformationFields {
...
export class MT103ExtendedRemittanceInformationParser {
  public static parse(rawSwiftBlock: string): Partial<MT103ExtendedRemittanceInformationFields> {
    const lines = rawSwiftBlock.split(/\r?\n/);
    const result: Partial<MT103ExtendedRemittanceInformationFields> = {};
  ...
  public static format(data: MT103ExtendedRemittanceInformationFields): string {
