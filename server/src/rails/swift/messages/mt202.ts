/**
 * SWIFT FIN Message Standard: MT202GeneralFinancialInstitutionTransfer
 * Description: General Financial Institution Transfer for interbank clearing
 * Compliant with SWIFT Standards Release 2026
 */

export interface MT202GeneralFinancialInstitutionTransferFields {
...
export class MT202GeneralFinancialInstitutionTransferParser {
  public static parse(rawSwiftBlock: string): Partial<MT202GeneralFinancialInstitutionTransferFields> {
    const lines = rawSwiftBlock.split(/\r?\n/);
    const result: Partial<MT202GeneralFinancialInstitutionTransferFields> = {};
  ...
  public static format(data: MT202GeneralFinancialInstitutionTransferFields): string {
