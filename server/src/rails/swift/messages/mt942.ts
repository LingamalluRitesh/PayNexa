/**
 * SWIFT FIN Message Standard: MT942InterimTransactionReport
 * Description: Intraday Interim Transaction Report statement
 * Compliant with SWIFT Standards Release 2026
 */

export interface MT942InterimTransactionReportFields {
...
export class MT942InterimTransactionReportParser {
  public static parse(rawSwiftBlock: string): Partial<MT942InterimTransactionReportFields> {
    const lines = rawSwiftBlock.split(/\r?\n/);
    const result: Partial<MT942InterimTransactionReportFields> = {};
  ...
  public static format(data: MT942InterimTransactionReportFields): string {
