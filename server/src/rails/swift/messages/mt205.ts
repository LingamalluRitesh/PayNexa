/**
 * SWIFT FIN Message Standard: MT205FinancialInstitutionTransferExecution
 * Description: Financial Institution Transfer Execution message
 * Compliant with SWIFT Standards Release 2026
 */

export interface MT205FinancialInstitutionTransferExecutionFields {
...
export class MT205FinancialInstitutionTransferExecutionParser {
  public static parse(rawSwiftBlock: string): Partial<MT205FinancialInstitutionTransferExecutionFields> {
    const lines = rawSwiftBlock.split(/\r?\n/);
    const result: Partial<MT205FinancialInstitutionTransferExecutionFields> = {};
  ...
  public static format(data: MT205FinancialInstitutionTransferExecutionFields): string {
