/**
 * SWIFT FIN Message Standard: MT202CoverPaymentTransfer
 * Description: Cover Payment Message for MT103 underlying settlement
 * Compliant with SWIFT Standards Release 2026
 */

export interface MT202CoverPaymentTransferFields {
...
export class MT202CoverPaymentTransferParser {
  public static parse(rawSwiftBlock: string): Partial<MT202CoverPaymentTransferFields> {
    const lines = rawSwiftBlock.split(/\r?\n/);
    const result: Partial<MT202CoverPaymentTransferFields> = {};
  ...
  public static format(data: MT202CoverPaymentTransferFields): string {
