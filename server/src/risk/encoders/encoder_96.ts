/**
 * Real-Time Risk Machine Learning Feature Transformer #96
 * Pipeline: Categorical Binning, Min-Max Normalization, and Outlier Truncation
 */

export interface FeatureVector96 {
...
export class FeatureTransformer96 {
  public static transform(input: FeatureVector96): number[] {
