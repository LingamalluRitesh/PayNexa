/**
 * Real-Time Risk Machine Learning Feature Transformer #105
 * Pipeline: Categorical Binning, Min-Max Normalization, and Outlier Truncation
 */

export interface FeatureVector105 {
...
export class FeatureTransformer105 {
  public static transform(input: FeatureVector105): number[] {
