/**
 * Real-Time Risk Machine Learning Feature Transformer #6
 * Pipeline: Categorical Binning, Min-Max Normalization, and Outlier Truncation
 */

export interface FeatureVector6 {
...
export class FeatureTransformer6 {
  public static transform(input: FeatureVector6): number[] {
