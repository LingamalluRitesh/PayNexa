/**
 * Real-Time Risk Machine Learning Feature Transformer #125
 * Pipeline: Categorical Binning, Min-Max Normalization, and Outlier Truncation
 */

export interface FeatureVector125 {
...
export class FeatureTransformer125 {
  public static transform(input: FeatureVector125): number[] {
