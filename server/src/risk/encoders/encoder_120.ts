/**
 * Real-Time Risk Machine Learning Feature Transformer #120
 * Pipeline: Categorical Binning, Min-Max Normalization, and Outlier Truncation
 */

export interface FeatureVector120 {
...
export class FeatureTransformer120 {
  public static transform(input: FeatureVector120): number[] {
