/**
 * Real-Time Risk Machine Learning Feature Transformer #91
 * Pipeline: Categorical Binning, Min-Max Normalization, and Outlier Truncation
 */

export interface FeatureVector91 {
...
export class FeatureTransformer91 {
  public static transform(input: FeatureVector91): number[] {
