/**
 * Real-Time Risk Machine Learning Feature Transformer #121
 * Pipeline: Categorical Binning, Min-Max Normalization, and Outlier Truncation
 */

export interface FeatureVector121 {
...
export class FeatureTransformer121 {
  public static transform(input: FeatureVector121): number[] {
