/**
 * Real-Time Risk Machine Learning Feature Transformer #2
 * Pipeline: Categorical Binning, Min-Max Normalization, and Outlier Truncation
 */

export interface FeatureVector2 {
...
export class FeatureTransformer2 {
  public static transform(input: FeatureVector2): number[] {
