/**
 * Real-Time Risk Machine Learning Feature Transformer #4
 * Pipeline: Categorical Binning, Min-Max Normalization, and Outlier Truncation
 */

export interface FeatureVector4 {
...
export class FeatureTransformer4 {
  public static transform(input: FeatureVector4): number[] {
