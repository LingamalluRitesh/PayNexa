/**
 * Real-Time Risk Machine Learning Feature Transformer #3
 * Pipeline: Categorical Binning, Min-Max Normalization, and Outlier Truncation
 */

export interface FeatureVector3 {
...
export class FeatureTransformer3 {
  public static transform(input: FeatureVector3): number[] {
