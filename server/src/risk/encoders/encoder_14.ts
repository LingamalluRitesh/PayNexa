/**
 * Real-Time Risk Machine Learning Feature Transformer #14
 * Pipeline: Categorical Binning, Min-Max Normalization, and Outlier Truncation
 */

export interface FeatureVector14 {
...
export class FeatureTransformer14 {
  public static transform(input: FeatureVector14): number[] {
