/**
 * Real-Time Risk Machine Learning Feature Transformer #90
 * Pipeline: Categorical Binning, Min-Max Normalization, and Outlier Truncation
 */

export interface FeatureVector90 {
...
export class FeatureTransformer90 {
  public static transform(input: FeatureVector90): number[] {
