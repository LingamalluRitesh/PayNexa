...
// DisputesService provides access to Dispute lifecycle and representment evidence.
...
// NewDisputesService initializes the resource service.
func NewDisputesService(client HTTPClient, baseURL, apiKey string) *DisputesService {
...
type DisputesServiceResponse struct {
...
func (s *DisputesService) Execute(ctx context.Context, method, endpoint string, payload interface{}) (*DisputesServiceResponse, error) {
	...
	var apiResp DisputesServiceResponse
