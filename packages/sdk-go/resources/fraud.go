...
// FraudService provides access to Risk assessment radar and transaction scoring.
...
// NewFraudService initializes the resource service.
func NewFraudService(client HTTPClient, baseURL, apiKey string) *FraudService {
	return &FraudService{
		client: client,
		baseURL: baseURL,
		apiKey: apiKey,
...
type FraudServiceResponse struct {
...
func (s *FraudService) Execute(ctx context.Context, method, endpoint string, payload interface{}) (*FraudServiceResponse, error) {
	...
	var apiResp FraudServiceResponse
