...
// TransactionsService provides access to Transaction indexing and query filters.
...
// NewTransactionsService initializes the resource service.
func NewTransactionsService(client HTTPClient, baseURL, apiKey string) *TransactionsService {
...
type TransactionsServiceResponse struct {
...
func (s *TransactionsService) Execute(ctx context.Context, method, endpoint string, payload interface{}) (*TransactionsServiceResponse, error) {
	...
	var apiResp TransactionsServiceResponse
