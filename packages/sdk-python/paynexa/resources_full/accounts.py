"""
PayNexa Python SDK: AccountsResource
Description: Account management and digital wallet balances
"""
...
class AccountsResource:
    ...
    def list(self, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        return self._request("GET", f"/accounts{query}")

    def get(self, resource_id: str) -> Dict[str, Any]:
        return self._request("GET", f"/accounts/{resource_id}")

    def create(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        return self._request("POST", f"/accounts", payload)
