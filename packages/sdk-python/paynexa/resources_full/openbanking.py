"""
PayNexa Python SDK: OpenBankingResource
Description: AISP and PISP consent and payment orchestration
"""
...
class OpenBankingResource:
    ...
    def list(self, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        return self._request("GET", f"/openbanking{query}")

    def get(self, resource_id: str) -> Dict[str, Any]:
        return self._request("GET", f"/openbanking/{resource_id}")

    def create(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        return self._request("POST", f"/openbanking", payload)
