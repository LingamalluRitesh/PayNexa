"""
PayNexa Python SDK: Iso20022Resource
Description: ISO 20022 pacs and camt XML generation
"""
...
class Iso20022Resource:
    ...
    def list(self, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        return self._request("GET", f"/iso20022{query}")

    def get(self, resource_id: str) -> Dict[str, Any]:
        return self._request("GET", f"/iso20022/{resource_id}")

    def create(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        return self._request("POST", f"/iso20022", payload)
