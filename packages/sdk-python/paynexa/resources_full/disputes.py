"""
PayNexa Python SDK: DisputesResource
Description: Dispute lifecycle and representment evidence
"""
...
class DisputesResource:
    ...
    def list(self, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        return self._request("GET", f"/disputes{query}")

    def get(self, resource_id: str) -> Dict[str, Any]:
        return self._request("GET", f"/disputes/{resource_id}")

    def create(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        return self._request("POST", f"/disputes", payload)
