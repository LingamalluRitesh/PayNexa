"""
PayNexa Python SDK: CardsResource
Description: Virtual card issuance and spending controls
"""
...
class CardsResource:
    ...
    def list(self, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        return self._request("GET", f"/cards{query}")

    def get(self, resource_id: str) -> Dict[str, Any]:
        return self._request("GET", f"/cards/{resource_id}")

    def create(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        return self._request("POST", f"/cards", payload)
