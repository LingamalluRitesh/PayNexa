"""
PayNexa Python SDK: FraudResource
Description: Risk assessment radar and transaction scoring
"""
...
class FraudResource:
    ...
    def list(self, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        return self._request("GET", f"/fraud{query}")

    def get(self, resource_id: str) -> Dict[str, Any]:
        return self._request("GET", f"/fraud/{resource_id}")

    def create(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        return self._request("POST", f"/fraud", payload)
