"""
PayNexa Python SDK: TransactionsResource
Description: Transaction indexing and query filters
"""
...
class TransactionsResource:
    ...
    def list(self, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        return self._request("GET", f"/transactions{query}")

    def get(self, resource_id: str) -> Dict[str, Any]:
        return self._request("GET", f"/transactions/{resource_id}")

    def create(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        return self._request("POST", f"/transactions", payload)
