"""
PayNexa Python SDK: TransfersResource
Description: Peer-to-peer and interbank fund transfers
"""
...
class TransfersResource:
    ...
    def list(self, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        return self._request("GET", f"/transfers{query}")

    def get(self, resource_id: str) -> Dict[str, Any]:
        return self._request("GET", f"/transfers/{resource_id}")

    def create(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        return self._request("POST", f"/transfers", payload)
