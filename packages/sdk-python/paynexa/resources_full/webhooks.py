"""
PayNexa Python SDK: WebhooksResource
Description: Webhook endpoint management and signature verification
"""
...
class WebhooksResource:
    ...
    def list(self, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        return self._request("GET", f"/webhooks{query}")

    def get(self, resource_id: str) -> Dict[str, Any]:
        return self._request("GET", f"/webhooks/{resource_id}")

    def create(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        return self._request("POST", f"/webhooks", payload)
