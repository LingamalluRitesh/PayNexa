"""
PayNexa Python SDK: ReconciliationResource
Description: 3-way reconciliation and break resolution
"""
...
class ReconciliationResource:
    ...
    def list(self, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        return self._request("GET", f"/reconciliation{query}")

    def get(self, resource_id: str) -> Dict[str, Any]:
        return self._request("GET", f"/reconciliation/{resource_id}")

    def create(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        return self._request("POST", f"/reconciliation", payload)
