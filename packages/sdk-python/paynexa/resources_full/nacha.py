"""
PayNexa Python SDK: NachaResource
Description: NACHA ACH batch generation and processing
"""
...
class NachaResource:
    ...
    def list(self, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        return self._request("GET", f"/nacha{query}")

    def get(self, resource_id: str) -> Dict[str, Any]:
        return self._request("GET", f"/nacha/{resource_id}")

    def create(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        return self._request("POST", f"/nacha", payload)
