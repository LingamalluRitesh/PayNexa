...
export class Iso20022Engine {
   ...
   */
  public generatePacs008Xml(doc: FIToFICustomerCreditTransferV10): string {
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.10" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
   ...
   */
  public generatePacs002Xml(doc: FIToFIPaymentStatusReportV12): string {
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:pacs.002.001.12">
   ...
   */
  public createPacs008Document(params: {
    endToEndId: string;
    amount: number;
    currency: string;
    debtorName: string;
    ...
    const tx: CreditTransferTransaction43 = {
