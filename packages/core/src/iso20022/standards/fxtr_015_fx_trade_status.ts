/**
 * ISO 20022 Message Standard: Fxtr015ForeignExchangeTradeStatusReport
 * Domain Category: FXTR
 * Business Purpose: Foreign Exchange Trade Clearing Status Report
 * Compliant with ISO 20022 Financial Repository v2026.1
 */

export interface Fxtr015ForeignExchangeTradeStatusReportEnvelope {
  ...
  document: Fxtr015ForeignExchangeTradeStatusReportDocument;
}

export interface Fxtr015ForeignExchangeTradeStatusReportDocument {
  header: Fxtr015ForeignExchangeTradeStatusReportHeader;
  transactionPayload: Fxtr015ForeignExchangeTradeStatusReportPayload[];
  reconciliationAuditSummary?: Fxtr015ForeignExchangeTradeStatusReportAudit;
}

export interface Fxtr015ForeignExchangeTradeStatusReportHeader {
...
export interface Fxtr015ForeignExchangeTradeStatusReportPayload {
...
export interface Fxtr015ForeignExchangeTradeStatusReportAudit {
...
export class Fxtr015ForeignExchangeTradeStatusReportEngine {
  public static validate(doc: Fxtr015ForeignExchangeTradeStatusReportDocument): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static serializeXml(doc: Fxtr015ForeignExchangeTradeStatusReportDocument): string {
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:$fxtr_015_fx_trade_status">
  <Header>
