/**
 * ISO 20022 Message Standard: Pain010MandateAmendmentRequest
 * Domain Category: PAIN
 * Business Purpose: Customer Mandate Amendment Request Message
 * Compliant with ISO 20022 Financial Repository v2026.1
 */

export interface Pain010MandateAmendmentRequestEnvelope {
  ...
  document: Pain010MandateAmendmentRequestDocument;
}

export interface Pain010MandateAmendmentRequestDocument {
  header: Pain010MandateAmendmentRequestHeader;
  transactionPayload: Pain010MandateAmendmentRequestPayload[];
  reconciliationAuditSummary?: Pain010MandateAmendmentRequestAudit;
}

export interface Pain010MandateAmendmentRequestHeader {
...
export interface Pain010MandateAmendmentRequestPayload {
...
export interface Pain010MandateAmendmentRequestAudit {
...
export class Pain010MandateAmendmentRequestEngine {
  public static validate(doc: Pain010MandateAmendmentRequestDocument): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static serializeXml(doc: Pain010MandateAmendmentRequestDocument): string {
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:$pain_010_mandate_amend">
  <Header>
