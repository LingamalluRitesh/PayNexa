/**
 * ISO 20022 Message Standard: Pacs002PaymentStatusReport
 * Domain Category: PACS
 * Business Purpose: Financial Institution Payment Status Report
 * Compliant with ISO 20022 Financial Repository v2026.1
 */

export interface Pacs002PaymentStatusReportEnvelope {
  ...
  document: Pacs002PaymentStatusReportDocument;
}

export interface Pacs002PaymentStatusReportDocument {
  header: Pacs002PaymentStatusReportHeader;
  transactionPayload: Pacs002PaymentStatusReportPayload[];
  reconciliationAuditSummary?: Pacs002PaymentStatusReportAudit;
}

export interface Pacs002PaymentStatusReportHeader {
...
export interface Pacs002PaymentStatusReportPayload {
...
export interface Pacs002PaymentStatusReportAudit {
...
export class Pacs002PaymentStatusReportEngine {
  public static validate(doc: Pacs002PaymentStatusReportDocument): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static serializeXml(doc: Pacs002PaymentStatusReportDocument): string {
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:$pacs_002_status_report">
  <Header>
