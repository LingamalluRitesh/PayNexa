/**
 * ISO 20022 Message Standard: Camt052AccountReport
 * Domain Category: CAMT
 * Business Purpose: Bank to Customer Account Report Intraday
 * Compliant with ISO 20022 Financial Repository v2026.1
 */

export interface Camt052AccountReportEnvelope {
  ...
  document: Camt052AccountReportDocument;
}

export interface Camt052AccountReportDocument {
  header: Camt052AccountReportHeader;
  transactionPayload: Camt052AccountReportPayload[];
  reconciliationAuditSummary?: Camt052AccountReportAudit;
}

export interface Camt052AccountReportHeader {
...
export interface Camt052AccountReportPayload {
...
export interface Camt052AccountReportAudit {
...
export class Camt052AccountReportEngine {
  public static validate(doc: Camt052AccountReportDocument): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static serializeXml(doc: Camt052AccountReportDocument): string {
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:$camt_052_report">
  <Header>
