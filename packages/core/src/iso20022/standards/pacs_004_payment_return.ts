/**
 * ISO 20022 Message Standard: Pacs004PaymentReturn
 * Domain Category: PACS
 * Business Purpose: Financial Institution Payment Return and Reversal
 * Compliant with ISO 20022 Financial Repository v2026.1
 */

export interface Pacs004PaymentReturnEnvelope {
  ...
  document: Pacs004PaymentReturnDocument;
}

export interface Pacs004PaymentReturnDocument {
  header: Pacs004PaymentReturnHeader;
  transactionPayload: Pacs004PaymentReturnPayload[];
  reconciliationAuditSummary?: Pacs004PaymentReturnAudit;
}

export interface Pacs004PaymentReturnHeader {
...
export interface Pacs004PaymentReturnAudit {
...
export class Pacs004PaymentReturnEngine {
  public static validate(doc: Pacs004PaymentReturnDocument): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static serializeXml(doc: Pacs004PaymentReturnDocument): string {
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:$pacs_004_payment_return">
  <Header>
