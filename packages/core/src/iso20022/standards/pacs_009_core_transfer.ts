/**
 * ISO 20022 Message Standard: Pacs009FinancialInstitutionCreditTransfer
 * Domain Category: PACS
 * Business Purpose: Core Interbank Financial Institution Credit Transfer
 * Compliant with ISO 20022 Financial Repository v2026.1
 */

export interface Pacs009FinancialInstitutionCreditTransferEnvelope {
  ...
  document: Pacs009FinancialInstitutionCreditTransferDocument;
}

export interface Pacs009FinancialInstitutionCreditTransferDocument {
  header: Pacs009FinancialInstitutionCreditTransferHeader;
  transactionPayload: Pacs009FinancialInstitutionCreditTransferPayload[];
  reconciliationAuditSummary?: Pacs009FinancialInstitutionCreditTransferAudit;
}

export interface Pacs009FinancialInstitutionCreditTransferHeader {
...
export interface Pacs009FinancialInstitutionCreditTransferPayload {
...
export interface Pacs009FinancialInstitutionCreditTransferAudit {
...
export class Pacs009FinancialInstitutionCreditTransferEngine {
  public static validate(doc: Pacs009FinancialInstitutionCreditTransferDocument): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static serializeXml(doc: Pacs009FinancialInstitutionCreditTransferDocument): string {
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:$pacs_009_core_transfer">
  <Header>
