/**
 * ISO 20022 Message Standard: Camt087RequestToModifyPayment
 * Domain Category: CAMT
 * Business Purpose: Interbank Request to Modify Payment Instruction
 * Compliant with ISO 20022 Financial Repository v2026.1
 */

export interface Camt087RequestToModifyPaymentEnvelope {
  ...
  document: Camt087RequestToModifyPaymentDocument;
}

export interface Camt087RequestToModifyPaymentDocument {
  header: Camt087RequestToModifyPaymentHeader;
  transactionPayload: Camt087RequestToModifyPaymentPayload[];
  reconciliationAuditSummary?: Camt087RequestToModifyPaymentAudit;
}

export interface Camt087RequestToModifyPaymentHeader {
...
export interface Camt087RequestToModifyPaymentPayload {
...
export interface Camt087RequestToModifyPaymentAudit {
...
export class Camt087RequestToModifyPaymentEngine {
  public static validate(doc: Camt087RequestToModifyPaymentDocument): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static serializeXml(doc: Camt087RequestToModifyPaymentDocument): string {
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:$camt_087_request_modify">
  <Header>
