/**
 * ISO 20022 Message Standard: Pain014PaymentActivationReport
 * Domain Category: PAIN
 * Business Purpose: Request for Payment Response and Status
 * Compliant with ISO 20022 Financial Repository v2026.1
 */

export interface Pain014PaymentActivationReportEnvelope {
  ...
  document: Pain014PaymentActivationReportDocument;
}

export interface Pain014PaymentActivationReportDocument {
  header: Pain014PaymentActivationReportHeader;
  transactionPayload: Pain014PaymentActivationReportPayload[];
  reconciliationAuditSummary?: Pain014PaymentActivationReportAudit;
}

export interface Pain014PaymentActivationReportHeader {
...
export interface Pain014PaymentActivationReportPayload {
...
export interface Pain014PaymentActivationReportAudit {
...
export class Pain014PaymentActivationReportEngine {
  public static validate(doc: Pain014PaymentActivationReportDocument): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static serializeXml(doc: Pain014PaymentActivationReportDocument): string {
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:$pain_014_payment_activation_report">
  <Header>
