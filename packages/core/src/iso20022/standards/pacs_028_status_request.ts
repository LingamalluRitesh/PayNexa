/**
 * ISO 20022 Message Standard: Pacs028PaymentStatusRequest
 * Domain Category: PACS
 * Business Purpose: Interbank Payment Status Request Query
 * Compliant with ISO 20022 Financial Repository v2026.1
 */

export interface Pacs028PaymentStatusRequestEnvelope {
  ...
  document: Pacs028PaymentStatusRequestDocument;
}

export interface Pacs028PaymentStatusRequestDocument {
  header: Pacs028PaymentStatusRequestHeader;
  transactionPayload: Pacs028PaymentStatusRequestPayload[];
  reconciliationAuditSummary?: Pacs028PaymentStatusRequestAudit;
}

export interface Pacs028PaymentStatusRequestHeader {
...
export interface Pacs028PaymentStatusRequestPayload {
...
export interface Pacs028PaymentStatusRequestAudit {
...
export class Pacs028PaymentStatusRequestEngine {
  public static validate(doc: Pacs028PaymentStatusRequestDocument): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static serializeXml(doc: Pacs028PaymentStatusRequestDocument): string {
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:$pacs_028_status_request">
  <Header>
