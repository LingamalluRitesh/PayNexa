/**
 * ISO 20022 Message Standard: Pain013CreditorPaymentActivationRequest
 * Domain Category: PAIN
 * Business Purpose: Request for Payment (RfP) Initiation
 * Compliant with ISO 20022 Financial Repository v2026.1
 */

export interface Pain013CreditorPaymentActivationRequestEnvelope {
  ...
  document: Pain013CreditorPaymentActivationRequestDocument;
}

export interface Pain013CreditorPaymentActivationRequestDocument {
  header: Pain013CreditorPaymentActivationRequestHeader;
  transactionPayload: Pain013CreditorPaymentActivationRequestPayload[];
  reconciliationAuditSummary?: Pain013CreditorPaymentActivationRequestAudit;
}

export interface Pain013CreditorPaymentActivationRequestHeader {
...
export interface Pain013CreditorPaymentActivationRequestPayload {
...
export interface Pain013CreditorPaymentActivationRequestAudit {
...
export class Pain013CreditorPaymentActivationRequestEngine {
  public static validate(doc: Pain013CreditorPaymentActivationRequestDocument): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static serializeXml(doc: Pain013CreditorPaymentActivationRequestDocument): string {
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:$pain_013_creditor_payment_act">
  <Header>
