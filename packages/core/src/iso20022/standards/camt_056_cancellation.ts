/**
 * ISO 20022 Message Standard: Camt056PaymentCancellation
 * Domain Category: CAMT
 * Business Purpose: Payment Cancellation and Recall Request
 * Compliant with ISO 20022 Financial Repository v2026.1
 */

export interface Camt056PaymentCancellationEnvelope {
  ...
  document: Camt056PaymentCancellationDocument;
}

export interface Camt056PaymentCancellationDocument {
  header: Camt056PaymentCancellationHeader;
  transactionPayload: Camt056PaymentCancellationPayload[];
  reconciliationAuditSummary?: Camt056PaymentCancellationAudit;
}

export interface Camt056PaymentCancellationHeader {
...
export interface Camt056PaymentCancellationPayload {
...
export interface Camt056PaymentCancellationAudit {
...
export class Camt056PaymentCancellationEngine {
  public static validate(doc: Camt056PaymentCancellationDocument): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static serializeXml(doc: Camt056PaymentCancellationDocument): string {
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:$camt_056_cancellation">
  <Header>
