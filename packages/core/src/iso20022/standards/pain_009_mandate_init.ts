/**
 * ISO 20022 Message Standard: Pain009MandateInitiationRequest
 * Domain Category: PAIN
 * Business Purpose: Customer Mandate Initiation Request Message
 * Compliant with ISO 20022 Financial Repository v2026.1
 */

export interface Pain009MandateInitiationRequestEnvelope {
  ...
  document: Pain009MandateInitiationRequestDocument;
}

export interface Pain009MandateInitiationRequestDocument {
  header: Pain009MandateInitiationRequestHeader;
  transactionPayload: Pain009MandateInitiationRequestPayload[];
  reconciliationAuditSummary?: Pain009MandateInitiationRequestAudit;
}

export interface Pain009MandateInitiationRequestHeader {
...
export interface Pain009MandateInitiationRequestPayload {
...
export interface Pain009MandateInitiationRequestAudit {
...
export class Pain009MandateInitiationRequestEngine {
  public static validate(doc: Pain009MandateInitiationRequestDocument): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static serializeXml(doc: Pain009MandateInitiationRequestDocument): string {
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:$pain_009_mandate_init">
  <Header>
