/**
 * ISO 20022 Message Standard: Pain012MandateAcceptanceReport
 * Domain Category: PAIN
 * Business Purpose: Customer Mandate Acceptance Report Message
 * Compliant with ISO 20022 Financial Repository v2026.1
 */

export interface Pain012MandateAcceptanceReportEnvelope {
  ...
  document: Pain012MandateAcceptanceReportDocument;
}

export interface Pain012MandateAcceptanceReportDocument {
  header: Pain012MandateAcceptanceReportHeader;
  transactionPayload: Pain012MandateAcceptanceReportPayload[];
  reconciliationAuditSummary?: Pain012MandateAcceptanceReportAudit;
}

export interface Pain012MandateAcceptanceReportHeader {
...
export interface Pain012MandateAcceptanceReportPayload {
...
export interface Pain012MandateAcceptanceReportAudit {
...
export class Pain012MandateAcceptanceReportEngine {
  public static validate(doc: Pain012MandateAcceptanceReportDocument): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static serializeXml(doc: Pain012MandateAcceptanceReportDocument): string {
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:$pain_012_mandate_accept">
  <Header>
