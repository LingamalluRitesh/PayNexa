/**
 * ISO 20022 Message Standard: Pain002CustomerPaymentStatusReport
 * Domain Category: PAIN
 * Business Purpose: Customer Payment Status Report Message
 * Compliant with ISO 20022 Financial Repository v2026.1
 */

export interface Pain002CustomerPaymentStatusReportEnvelope {
  ...
  document: Pain002CustomerPaymentStatusReportDocument;
}

export interface Pain002CustomerPaymentStatusReportDocument {
  header: Pain002CustomerPaymentStatusReportHeader;
  transactionPayload: Pain002CustomerPaymentStatusReportPayload[];
  reconciliationAuditSummary?: Pain002CustomerPaymentStatusReportAudit;
}

export interface Pain002CustomerPaymentStatusReportHeader {
...
export interface Pain002CustomerPaymentStatusReportPayload {
...
export interface Pain002CustomerPaymentStatusReportAudit {
...
export class Pain002CustomerPaymentStatusReportEngine {
  public static validate(doc: Pain002CustomerPaymentStatusReportDocument): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static serializeXml(doc: Pain002CustomerPaymentStatusReportDocument): string {
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:$pain_002_status_report">
  <Header>
