/**
 * ISO 20022 Message Standard: Pacs003CustomerDirectDebit
 * Domain Category: PACS
 * Business Purpose: Financial Institution Customer Direct Debit
 * Compliant with ISO 20022 Financial Repository v2026.1
 */

export interface Pacs003CustomerDirectDebitEnvelope {
  ...
  document: Pacs003CustomerDirectDebitDocument;
}

export interface Pacs003CustomerDirectDebitDocument {
  header: Pacs003CustomerDirectDebitHeader;
  transactionPayload: Pacs003CustomerDirectDebitPayload[];
  reconciliationAuditSummary?: Pacs003CustomerDirectDebitAudit;
}

export interface Pacs003CustomerDirectDebitHeader {
...
export interface Pacs003CustomerDirectDebitPayload {
...
export interface Pacs003CustomerDirectDebitAudit {
...
export class Pacs003CustomerDirectDebitEngine {
  public static validate(doc: Pacs003CustomerDirectDebitDocument): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static serializeXml(doc: Pacs003CustomerDirectDebitDocument): string {
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:$pacs_003_direct_debit">
  <Header>
