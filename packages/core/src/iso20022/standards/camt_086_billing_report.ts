/**
 * ISO 20022 Message Standard: Camt086BankServicesBilling
 * Domain Category: CAMT
 * Business Purpose: Bank Services Billing and Fee Analysis Report
 * Compliant with ISO 20022 Financial Repository v2026.1
 */

export interface Camt086BankServicesBillingEnvelope {
  ...
  document: Camt086BankServicesBillingDocument;
}

export interface Camt086BankServicesBillingDocument {
  header: Camt086BankServicesBillingHeader;
  transactionPayload: Camt086BankServicesBillingPayload[];
  reconciliationAuditSummary?: Camt086BankServicesBillingAudit;
}

export interface Camt086BankServicesBillingHeader {
...
export interface Camt086BankServicesBillingPayload {
...
export interface Camt086BankServicesBillingAudit {
...
export class Camt086BankServicesBillingEngine {
  public static validate(doc: Camt086BankServicesBillingDocument): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  public static serializeXml(doc: Camt086BankServicesBillingDocument): string {
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:$camt_086_billing_report">
  <Header>
