/**
 * ISO 20022 Specification: pacs.004.001.11
 * Message: PaymentReturnV11
 * Description: Payment Return and Direct Reversal
 * Compliant with ISO 20022 Financial Repository & EPC Rulebook
 */

export interface PaymentReturnV11Document {
  document: {
    paymentReturnV11: PaymentReturnV11;
  };
}

export interface PaymentReturnV11 {
  groupHeader: PaymentReturnV11GroupHeader;
  transactionInformation: PaymentReturnV11Transaction[];
...
export interface PaymentReturnV11GroupHeader {
  ...
  initiatingParty?: PaymentReturnV11Party;
  forwardingAgent?: PaymentReturnV11BranchAndFinancialInstitution;
  debtorAgent?: PaymentReturnV11BranchAndFinancialInstitution;
  creditorAgent?: PaymentReturnV11BranchAndFinancialInstitution;
}

export interface PaymentReturnV11Transaction {
  ...
  originalTransactionReference?: {
    ...
    debtor?: PaymentReturnV11Party;
    creditor?: PaymentReturnV11Party;
  };
  statusReasonInformation?: Array<{
    originator?: PaymentReturnV11Party;
  ...
  chargesInformation?: Array<{
    amount: { value: number; currency: string };
    agent: PaymentReturnV11BranchAndFinancialInstitution;
  }>;
  debtor?: PaymentReturnV11Party;
  debtorAccount?: PaymentReturnV11CashAccount;
  debtorAgent?: PaymentReturnV11BranchAndFinancialInstitution;
  creditorAgent?: PaymentReturnV11BranchAndFinancialInstitution;
  creditor?: PaymentReturnV11Party;
  creditorAccount?: PaymentReturnV11CashAccount;
  ultimateDebtor?: PaymentReturnV11Party;
  ultimateCreditor?: PaymentReturnV11Party;
  ...
  remittanceInformation?: {
    ...
    structured?: Array<{
      ...
      invoicer?: PaymentReturnV11Party;
      invoicee?: PaymentReturnV11Party;
    }>;
  };
}

export interface PaymentReturnV11Party {
  name: string;
  postalAddress?: {
...
export interface PaymentReturnV11CashAccount {
  identification: {
    iban?: string;
...
export interface PaymentReturnV11BranchAndFinancialInstitution {
  financialInstitutionIdentification: {
    ...
    lei?: string;
    name?: string;
    postalAddress?: PaymentReturnV11Party['postalAddress'];
  };
...
export class PaymentReturnV11Parser {
  public static parseXml(xml: string): PaymentReturnV11 {
  ...
  public static buildXml(doc: PaymentReturnV11): string {
