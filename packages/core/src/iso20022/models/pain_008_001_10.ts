/**
 * ISO 20022 Specification: pain.008.001.10
 * Message: CustomerDirectDebitInitiationV10
 * Description: Corporate Customer Direct Debit Initiation
 * Compliant with ISO 20022 Financial Repository & EPC Rulebook
 */

export interface CustomerDirectDebitInitiationV10Document {
  document: {
    customerDirectDebitInitiationV10: CustomerDirectDebitInitiationV10;
  };
}

export interface CustomerDirectDebitInitiationV10 {
  groupHeader: CustomerDirectDebitInitiationV10GroupHeader;
  transactionInformation: CustomerDirectDebitInitiationV10Transaction[];
...
export interface CustomerDirectDebitInitiationV10GroupHeader {
  ...
  initiatingParty?: CustomerDirectDebitInitiationV10Party;
  forwardingAgent?: CustomerDirectDebitInitiationV10BranchAndFinancialInstitution;
  debtorAgent?: CustomerDirectDebitInitiationV10BranchAndFinancialInstitution;
  creditorAgent?: CustomerDirectDebitInitiationV10BranchAndFinancialInstitution;
}

export interface CustomerDirectDebitInitiationV10Transaction {
  ...
  originalTransactionReference?: {
    ...
    debtor?: CustomerDirectDebitInitiationV10Party;
    creditor?: CustomerDirectDebitInitiationV10Party;
  };
  statusReasonInformation?: Array<{
    originator?: CustomerDirectDebitInitiationV10Party;
  ...
  chargesInformation?: Array<{
    amount: { value: number; currency: string };
    agent: CustomerDirectDebitInitiationV10BranchAndFinancialInstitution;
  }>;
  debtor?: CustomerDirectDebitInitiationV10Party;
  debtorAccount?: CustomerDirectDebitInitiationV10CashAccount;
  debtorAgent?: CustomerDirectDebitInitiationV10BranchAndFinancialInstitution;
  creditorAgent?: CustomerDirectDebitInitiationV10BranchAndFinancialInstitution;
  creditor?: CustomerDirectDebitInitiationV10Party;
  creditorAccount?: CustomerDirectDebitInitiationV10CashAccount;
  ultimateDebtor?: CustomerDirectDebitInitiationV10Party;
  ultimateCreditor?: CustomerDirectDebitInitiationV10Party;
  ...
  remittanceInformation?: {
    ...
    structured?: Array<{
      ...
      invoicer?: CustomerDirectDebitInitiationV10Party;
      invoicee?: CustomerDirectDebitInitiationV10Party;
    }>;
  };
}

export interface CustomerDirectDebitInitiationV10Party {
  name: string;
  postalAddress?: {
...
export interface CustomerDirectDebitInitiationV10CashAccount {
  identification: {
    iban?: string;
...
export interface CustomerDirectDebitInitiationV10BranchAndFinancialInstitution {
  financialInstitutionIdentification: {
    ...
    lei?: string;
    name?: string;
    postalAddress?: CustomerDirectDebitInitiationV10Party['postalAddress'];
  };
...
export class CustomerDirectDebitInitiationV10Parser {
  public static parseXml(xml: string): CustomerDirectDebitInitiationV10 {
  ...
  public static buildXml(doc: CustomerDirectDebitInitiationV10): string {
