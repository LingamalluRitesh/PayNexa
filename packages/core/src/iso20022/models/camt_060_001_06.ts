/**
 * ISO 20022 Specification: camt.060.001.06
 * Message: AccountReportingRequestV06
 * Description: Account Transaction Reporting Request
 * Compliant with ISO 20022 Financial Repository & EPC Rulebook
 */

export interface AccountReportingRequestV06Document {
  document: {
    accountReportingRequestV06: AccountReportingRequestV06;
  };
}

export interface AccountReportingRequestV06 {
  groupHeader: AccountReportingRequestV06GroupHeader;
  transactionInformation: AccountReportingRequestV06Transaction[];
...
export interface AccountReportingRequestV06GroupHeader {
  ...
  initiatingParty?: AccountReportingRequestV06Party;
  forwardingAgent?: AccountReportingRequestV06BranchAndFinancialInstitution;
  debtorAgent?: AccountReportingRequestV06BranchAndFinancialInstitution;
  creditorAgent?: AccountReportingRequestV06BranchAndFinancialInstitution;
}

export interface AccountReportingRequestV06Transaction {
  ...
  originalTransactionReference?: {
    ...
    debtor?: AccountReportingRequestV06Party;
    creditor?: AccountReportingRequestV06Party;
  };
  statusReasonInformation?: Array<{
    originator?: AccountReportingRequestV06Party;
  ...
  chargesInformation?: Array<{
    amount: { value: number; currency: string };
    agent: AccountReportingRequestV06BranchAndFinancialInstitution;
  }>;
  debtor?: AccountReportingRequestV06Party;
  debtorAccount?: AccountReportingRequestV06CashAccount;
  debtorAgent?: AccountReportingRequestV06BranchAndFinancialInstitution;
  creditorAgent?: AccountReportingRequestV06BranchAndFinancialInstitution;
  creditor?: AccountReportingRequestV06Party;
  creditorAccount?: AccountReportingRequestV06CashAccount;
  ultimateDebtor?: AccountReportingRequestV06Party;
  ultimateCreditor?: AccountReportingRequestV06Party;
  ...
  remittanceInformation?: {
    ...
    structured?: Array<{
      ...
      invoicer?: AccountReportingRequestV06Party;
      invoicee?: AccountReportingRequestV06Party;
    }>;
  };
}

export interface AccountReportingRequestV06Party {
  name: string;
  postalAddress?: {
...
export interface AccountReportingRequestV06CashAccount {
  identification: {
    iban?: string;
...
export interface AccountReportingRequestV06BranchAndFinancialInstitution {
  financialInstitutionIdentification: {
    ...
    lei?: string;
    name?: string;
    postalAddress?: AccountReportingRequestV06Party['postalAddress'];
  };
...
export class AccountReportingRequestV06Parser {
  public static parseXml(xml: string): AccountReportingRequestV06 {
  ...
  public static buildXml(doc: AccountReportingRequestV06): string {
