/**
 * ISO 20022 Specification: pain.007.001.10
 * Message: CustomerPaymentReversalV10
 * Description: Customer Payment Direct Reversal Initiation
 * Compliant with ISO 20022 Financial Repository & EPC Rulebook
 */

export interface CustomerPaymentReversalV10Document {
  document: {
    customerPaymentReversalV10: CustomerPaymentReversalV10;
  };
}

export interface CustomerPaymentReversalV10 {
  groupHeader: CustomerPaymentReversalV10GroupHeader;
  transactionInformation: CustomerPaymentReversalV10Transaction[];
...
export interface CustomerPaymentReversalV10GroupHeader {
  ...
  initiatingParty?: CustomerPaymentReversalV10Party;
  forwardingAgent?: CustomerPaymentReversalV10BranchAndFinancialInstitution;
  debtorAgent?: CustomerPaymentReversalV10BranchAndFinancialInstitution;
  creditorAgent?: CustomerPaymentReversalV10BranchAndFinancialInstitution;
}

export interface CustomerPaymentReversalV10Transaction {
  ...
  originalTransactionReference?: {
    ...
    debtor?: CustomerPaymentReversalV10Party;
    creditor?: CustomerPaymentReversalV10Party;
  };
  statusReasonInformation?: Array<{
    originator?: CustomerPaymentReversalV10Party;
  ...
  chargesInformation?: Array<{
    amount: { value: number; currency: string };
    agent: CustomerPaymentReversalV10BranchAndFinancialInstitution;
  }>;
  debtor?: CustomerPaymentReversalV10Party;
  debtorAccount?: CustomerPaymentReversalV10CashAccount;
  debtorAgent?: CustomerPaymentReversalV10BranchAndFinancialInstitution;
  creditorAgent?: CustomerPaymentReversalV10BranchAndFinancialInstitution;
  creditor?: CustomerPaymentReversalV10Party;
  creditorAccount?: CustomerPaymentReversalV10CashAccount;
  ultimateDebtor?: CustomerPaymentReversalV10Party;
  ultimateCreditor?: CustomerPaymentReversalV10Party;
  ...
  remittanceInformation?: {
    ...
    structured?: Array<{
      ...
      invoicer?: CustomerPaymentReversalV10Party;
      invoicee?: CustomerPaymentReversalV10Party;
    }>;
  };
}

export interface CustomerPaymentReversalV10Party {
  name: string;
  postalAddress?: {
...
export interface CustomerPaymentReversalV10CashAccount {
  identification: {
    iban?: string;
...
export interface CustomerPaymentReversalV10BranchAndFinancialInstitution {
  financialInstitutionIdentification: {
    ...
    lei?: string;
    name?: string;
    postalAddress?: CustomerPaymentReversalV10Party['postalAddress'];
  };
...
export class CustomerPaymentReversalV10Parser {
  public static parseXml(xml: string): CustomerPaymentReversalV10 {
  ...
  public static buildXml(doc: CustomerPaymentReversalV10): string {
