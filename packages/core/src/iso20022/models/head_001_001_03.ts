/**
 * ISO 20022 Specification: head.001.001.03
 * Message: BusinessApplicationHeaderV03
 * Description: ISO 20022 Business Application Header (BAH)
 * Compliant with ISO 20022 Financial Repository & EPC Rulebook
 */

export interface BusinessApplicationHeaderV03Document {
  document: {
    businessApplicationHeaderV03: BusinessApplicationHeaderV03;
  };
}

export interface BusinessApplicationHeaderV03 {
  groupHeader: BusinessApplicationHeaderV03GroupHeader;
  transactionInformation: BusinessApplicationHeaderV03Transaction[];
...
export interface BusinessApplicationHeaderV03GroupHeader {
  ...
  initiatingParty?: BusinessApplicationHeaderV03Party;
  forwardingAgent?: BusinessApplicationHeaderV03BranchAndFinancialInstitution;
  debtorAgent?: BusinessApplicationHeaderV03BranchAndFinancialInstitution;
  creditorAgent?: BusinessApplicationHeaderV03BranchAndFinancialInstitution;
}

export interface BusinessApplicationHeaderV03Transaction {
  ...
  originalTransactionReference?: {
    ...
    debtor?: BusinessApplicationHeaderV03Party;
    creditor?: BusinessApplicationHeaderV03Party;
  };
  statusReasonInformation?: Array<{
    originator?: BusinessApplicationHeaderV03Party;
  ...
  chargesInformation?: Array<{
    amount: { value: number; currency: string };
    agent: BusinessApplicationHeaderV03BranchAndFinancialInstitution;
  }>;
  debtor?: BusinessApplicationHeaderV03Party;
  debtorAccount?: BusinessApplicationHeaderV03CashAccount;
  debtorAgent?: BusinessApplicationHeaderV03BranchAndFinancialInstitution;
  creditorAgent?: BusinessApplicationHeaderV03BranchAndFinancialInstitution;
  creditor?: BusinessApplicationHeaderV03Party;
  creditorAccount?: BusinessApplicationHeaderV03CashAccount;
  ultimateDebtor?: BusinessApplicationHeaderV03Party;
  ultimateCreditor?: BusinessApplicationHeaderV03Party;
  ...
  remittanceInformation?: {
    ...
    structured?: Array<{
      ...
      invoicer?: BusinessApplicationHeaderV03Party;
      invoicee?: BusinessApplicationHeaderV03Party;
    }>;
  };
}

export interface BusinessApplicationHeaderV03Party {
  name: string;
  postalAddress?: {
...
export interface BusinessApplicationHeaderV03CashAccount {
  identification: {
    iban?: string;
...
export interface BusinessApplicationHeaderV03BranchAndFinancialInstitution {
  financialInstitutionIdentification: {
    ...
    lei?: string;
    name?: string;
    postalAddress?: BusinessApplicationHeaderV03Party['postalAddress'];
  };
...
export class BusinessApplicationHeaderV03Parser {
  public static parseXml(xml: string): BusinessApplicationHeaderV03 {
  ...
  public static buildXml(doc: BusinessApplicationHeaderV03): string {
