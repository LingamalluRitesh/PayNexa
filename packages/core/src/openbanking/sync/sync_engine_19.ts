/**
 * Open Banking Data Extraction & Ledger Synchronizer #19
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed19 {
...
export class StatementSyncService19 {
  public static reconcile(feed: BankStatementFeed19): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
