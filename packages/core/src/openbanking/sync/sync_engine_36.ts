/**
 * Open Banking Data Extraction & Ledger Synchronizer #36
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed36 {
...
export class StatementSyncService36 {
  public static reconcile(feed: BankStatementFeed36): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
