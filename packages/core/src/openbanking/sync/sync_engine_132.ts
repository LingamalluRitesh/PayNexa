/**
 * Open Banking Data Extraction & Ledger Synchronizer #132
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed132 {
...
export class StatementSyncService132 {
  public static reconcile(feed: BankStatementFeed132): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
