/**
 * Open Banking Data Extraction & Ledger Synchronizer #65
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed65 {
...
export class StatementSyncService65 {
  public static reconcile(feed: BankStatementFeed65): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
