/**
 * Open Banking Data Extraction & Ledger Synchronizer #186
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed186 {
...
export class StatementSyncService186 {
  public static reconcile(feed: BankStatementFeed186): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
