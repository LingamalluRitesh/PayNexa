/**
 * Open Banking Data Extraction & Ledger Synchronizer #193
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed193 {
...
export class StatementSyncService193 {
  public static reconcile(feed: BankStatementFeed193): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
