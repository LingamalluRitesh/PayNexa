/**
 * Open Banking Data Extraction & Ledger Synchronizer #34
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed34 {
...
export class StatementSyncService34 {
  public static reconcile(feed: BankStatementFeed34): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
