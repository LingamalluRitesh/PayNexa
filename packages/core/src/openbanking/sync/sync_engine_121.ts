/**
 * Open Banking Data Extraction & Ledger Synchronizer #121
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed121 {
...
export class StatementSyncService121 {
  public static reconcile(feed: BankStatementFeed121): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
