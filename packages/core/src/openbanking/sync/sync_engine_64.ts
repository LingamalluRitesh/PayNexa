/**
 * Open Banking Data Extraction & Ledger Synchronizer #64
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed64 {
...
export class StatementSyncService64 {
  public static reconcile(feed: BankStatementFeed64): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
