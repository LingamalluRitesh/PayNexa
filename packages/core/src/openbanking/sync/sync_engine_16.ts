/**
 * Open Banking Data Extraction & Ledger Synchronizer #16
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed16 {
...
export class StatementSyncService16 {
  public static reconcile(feed: BankStatementFeed16): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
