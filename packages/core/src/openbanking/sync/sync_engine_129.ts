/**
 * Open Banking Data Extraction & Ledger Synchronizer #129
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed129 {
...
export class StatementSyncService129 {
  public static reconcile(feed: BankStatementFeed129): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
