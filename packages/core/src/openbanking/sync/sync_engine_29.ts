/**
 * Open Banking Data Extraction & Ledger Synchronizer #29
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed29 {
...
export class StatementSyncService29 {
  public static reconcile(feed: BankStatementFeed29): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
