/**
 * Open Banking Data Extraction & Ledger Synchronizer #177
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed177 {
...
export class StatementSyncService177 {
  public static reconcile(feed: BankStatementFeed177): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
