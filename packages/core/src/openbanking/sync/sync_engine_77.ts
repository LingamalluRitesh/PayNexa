/**
 * Open Banking Data Extraction & Ledger Synchronizer #77
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed77 {
...
export class StatementSyncService77 {
  public static reconcile(feed: BankStatementFeed77): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
