/**
 * Open Banking Data Extraction & Ledger Synchronizer #31
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed31 {
...
export class StatementSyncService31 {
  public static reconcile(feed: BankStatementFeed31): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
