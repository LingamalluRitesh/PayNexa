/**
 * Open Banking Data Extraction & Ledger Synchronizer #11
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed11 {
...
export class StatementSyncService11 {
  public static reconcile(feed: BankStatementFeed11): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
