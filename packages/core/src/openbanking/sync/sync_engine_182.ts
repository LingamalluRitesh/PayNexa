/**
 * Open Banking Data Extraction & Ledger Synchronizer #182
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed182 {
...
export class StatementSyncService182 {
  public static reconcile(feed: BankStatementFeed182): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
