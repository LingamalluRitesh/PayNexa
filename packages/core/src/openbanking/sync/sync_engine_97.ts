/**
 * Open Banking Data Extraction & Ledger Synchronizer #97
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed97 {
...
export class StatementSyncService97 {
  public static reconcile(feed: BankStatementFeed97): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
