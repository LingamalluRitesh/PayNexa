/**
 * Open Banking Data Extraction & Ledger Synchronizer #101
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed101 {
...
export class StatementSyncService101 {
  public static reconcile(feed: BankStatementFeed101): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
