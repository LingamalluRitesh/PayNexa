/**
 * Open Banking Data Extraction & Ledger Synchronizer #35
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed35 {
...
export class StatementSyncService35 {
  public static reconcile(feed: BankStatementFeed35): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
