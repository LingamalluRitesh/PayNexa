/**
 * Open Banking Data Extraction & Ledger Synchronizer #188
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed188 {
...
export class StatementSyncService188 {
  public static reconcile(feed: BankStatementFeed188): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
