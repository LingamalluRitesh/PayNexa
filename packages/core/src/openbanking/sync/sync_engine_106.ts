/**
 * Open Banking Data Extraction & Ledger Synchronizer #106
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed106 {
...
export class StatementSyncService106 {
  public static reconcile(feed: BankStatementFeed106): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
