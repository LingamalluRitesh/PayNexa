/**
 * Open Banking Data Extraction & Ledger Synchronizer #102
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed102 {
...
export class StatementSyncService102 {
  public static reconcile(feed: BankStatementFeed102): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
