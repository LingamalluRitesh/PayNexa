/**
 * Open Banking Data Extraction & Ledger Synchronizer #197
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed197 {
...
export class StatementSyncService197 {
  public static reconcile(feed: BankStatementFeed197): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
