/**
 * Open Banking Data Extraction & Ledger Synchronizer #155
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed155 {
...
export class StatementSyncService155 {
  public static reconcile(feed: BankStatementFeed155): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
