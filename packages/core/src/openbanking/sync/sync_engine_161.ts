/**
 * Open Banking Data Extraction & Ledger Synchronizer #161
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed161 {
...
export class StatementSyncService161 {
  public static reconcile(feed: BankStatementFeed161): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
