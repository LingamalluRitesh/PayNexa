/**
 * Open Banking Data Extraction & Ledger Synchronizer #114
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed114 {
...
export class StatementSyncService114 {
  public static reconcile(feed: BankStatementFeed114): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
