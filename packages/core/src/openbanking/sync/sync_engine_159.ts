/**
 * Open Banking Data Extraction & Ledger Synchronizer #159
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed159 {
...
export class StatementSyncService159 {
  public static reconcile(feed: BankStatementFeed159): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
