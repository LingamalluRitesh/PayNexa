/**
 * Open Banking Data Extraction & Ledger Synchronizer #135
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed135 {
...
export class StatementSyncService135 {
  public static reconcile(feed: BankStatementFeed135): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
