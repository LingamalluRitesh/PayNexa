/**
 * Open Banking Data Extraction & Ledger Synchronizer #100
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed100 {
...
export class StatementSyncService100 {
  public static reconcile(feed: BankStatementFeed100): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
