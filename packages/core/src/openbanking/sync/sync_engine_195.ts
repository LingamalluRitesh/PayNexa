/**
 * Open Banking Data Extraction & Ledger Synchronizer #195
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed195 {
...
export class StatementSyncService195 {
  public static reconcile(feed: BankStatementFeed195): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
