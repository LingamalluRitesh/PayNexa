/**
 * Open Banking Data Extraction & Ledger Synchronizer #123
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed123 {
...
export class StatementSyncService123 {
  public static reconcile(feed: BankStatementFeed123): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
