/**
 * Open Banking Data Extraction & Ledger Synchronizer #115
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed115 {
...
export class StatementSyncService115 {
  public static reconcile(feed: BankStatementFeed115): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
