/**
 * Open Banking Data Extraction & Ledger Synchronizer #127
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed127 {
...
export class StatementSyncService127 {
  public static reconcile(feed: BankStatementFeed127): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
