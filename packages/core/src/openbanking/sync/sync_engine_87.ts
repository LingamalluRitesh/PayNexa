/**
 * Open Banking Data Extraction & Ledger Synchronizer #87
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed87 {
...
export class StatementSyncService87 {
  public static reconcile(feed: BankStatementFeed87): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
