/**
 * Open Banking Data Extraction & Ledger Synchronizer #27
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed27 {
...
export class StatementSyncService27 {
  public static reconcile(feed: BankStatementFeed27): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
