/**
 * Open Banking Data Extraction & Ledger Synchronizer #30
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed30 {
...
export class StatementSyncService30 {
  public static reconcile(feed: BankStatementFeed30): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
