/**
 * Open Banking Data Extraction & Ledger Synchronizer #55
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed55 {
...
export class StatementSyncService55 {
  public static reconcile(feed: BankStatementFeed55): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
