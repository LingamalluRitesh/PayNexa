/**
 * Open Banking Data Extraction & Ledger Synchronizer #137
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed137 {
...
export class StatementSyncService137 {
  public static reconcile(feed: BankStatementFeed137): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
