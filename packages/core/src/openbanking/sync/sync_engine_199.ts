/**
 * Open Banking Data Extraction & Ledger Synchronizer #199
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed199 {
...
export class StatementSyncService199 {
  public static reconcile(feed: BankStatementFeed199): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
