/**
 * Open Banking Data Extraction & Ledger Synchronizer #2
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed2 {
...
export class StatementSyncService2 {
  public static reconcile(feed: BankStatementFeed2): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
