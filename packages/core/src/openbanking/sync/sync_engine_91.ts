/**
 * Open Banking Data Extraction & Ledger Synchronizer #91
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed91 {
...
export class StatementSyncService91 {
  public static reconcile(feed: BankStatementFeed91): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
