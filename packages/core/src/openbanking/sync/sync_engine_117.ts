/**
 * Open Banking Data Extraction & Ledger Synchronizer #117
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed117 {
...
export class StatementSyncService117 {
  public static reconcile(feed: BankStatementFeed117): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
