/**
 * Open Banking Data Extraction & Ledger Synchronizer #179
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed179 {
...
export class StatementSyncService179 {
  public static reconcile(feed: BankStatementFeed179): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
