/**
 * Open Banking Data Extraction & Ledger Synchronizer #79
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed79 {
...
export class StatementSyncService79 {
  public static reconcile(feed: BankStatementFeed79): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
