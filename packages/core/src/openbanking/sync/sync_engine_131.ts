/**
 * Open Banking Data Extraction & Ledger Synchronizer #131
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed131 {
...
export class StatementSyncService131 {
  public static reconcile(feed: BankStatementFeed131): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
