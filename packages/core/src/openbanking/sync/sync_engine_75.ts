/**
 * Open Banking Data Extraction & Ledger Synchronizer #75
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed75 {
...
export class StatementSyncService75 {
  public static reconcile(feed: BankStatementFeed75): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
