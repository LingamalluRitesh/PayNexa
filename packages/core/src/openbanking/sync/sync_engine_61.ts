/**
 * Open Banking Data Extraction & Ledger Synchronizer #61
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed61 {
...
export class StatementSyncService61 {
  public static reconcile(feed: BankStatementFeed61): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
