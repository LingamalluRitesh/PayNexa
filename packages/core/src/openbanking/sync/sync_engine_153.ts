/**
 * Open Banking Data Extraction & Ledger Synchronizer #153
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed153 {
...
export class StatementSyncService153 {
  public static reconcile(feed: BankStatementFeed153): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
