/**
 * Open Banking Data Extraction & Ledger Synchronizer #130
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed130 {
...
export class StatementSyncService130 {
  public static reconcile(feed: BankStatementFeed130): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
