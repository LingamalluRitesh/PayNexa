/**
 * Open Banking Data Extraction & Ledger Synchronizer #62
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed62 {
...
export class StatementSyncService62 {
  public static reconcile(feed: BankStatementFeed62): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
