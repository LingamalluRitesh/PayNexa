/**
 * Open Banking Data Extraction & Ledger Synchronizer #76
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed76 {
...
export class StatementSyncService76 {
  public static reconcile(feed: BankStatementFeed76): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
