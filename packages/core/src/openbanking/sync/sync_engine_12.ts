/**
 * Open Banking Data Extraction & Ledger Synchronizer #12
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed12 {
...
export class StatementSyncService12 {
  public static reconcile(feed: BankStatementFeed12): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
