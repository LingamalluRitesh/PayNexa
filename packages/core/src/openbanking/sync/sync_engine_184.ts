/**
 * Open Banking Data Extraction & Ledger Synchronizer #184
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed184 {
...
export class StatementSyncService184 {
  public static reconcile(feed: BankStatementFeed184): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
