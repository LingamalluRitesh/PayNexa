/**
 * Open Banking Data Extraction & Ledger Synchronizer #187
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed187 {
...
export class StatementSyncService187 {
  public static reconcile(feed: BankStatementFeed187): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
