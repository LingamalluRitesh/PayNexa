/**
 * Open Banking Data Extraction & Ledger Synchronizer #109
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed109 {
...
export class StatementSyncService109 {
  public static reconcile(feed: BankStatementFeed109): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
