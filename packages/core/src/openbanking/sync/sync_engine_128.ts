/**
 * Open Banking Data Extraction & Ledger Synchronizer #128
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed128 {
...
export class StatementSyncService128 {
  public static reconcile(feed: BankStatementFeed128): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
