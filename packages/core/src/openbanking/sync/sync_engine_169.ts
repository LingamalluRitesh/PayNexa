/**
 * Open Banking Data Extraction & Ledger Synchronizer #169
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed169 {
...
export class StatementSyncService169 {
  public static reconcile(feed: BankStatementFeed169): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
