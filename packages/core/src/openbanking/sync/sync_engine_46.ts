/**
 * Open Banking Data Extraction & Ledger Synchronizer #46
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed46 {
...
export class StatementSyncService46 {
  public static reconcile(feed: BankStatementFeed46): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
