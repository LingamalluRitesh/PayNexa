/**
 * Open Banking Data Extraction & Ledger Synchronizer #119
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed119 {
...
export class StatementSyncService119 {
  public static reconcile(feed: BankStatementFeed119): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
