/**
 * Open Banking Data Extraction & Ledger Synchronizer #6
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed6 {
...
export class StatementSyncService6 {
  public static reconcile(feed: BankStatementFeed6): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
