/**
 * Open Banking Data Extraction & Ledger Synchronizer #41
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed41 {
...
export class StatementSyncService41 {
  public static reconcile(feed: BankStatementFeed41): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
