/**
 * Open Banking Data Extraction & Ledger Synchronizer #99
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed99 {
...
export class StatementSyncService99 {
  public static reconcile(feed: BankStatementFeed99): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
