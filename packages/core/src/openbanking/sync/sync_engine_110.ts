/**
 * Open Banking Data Extraction & Ledger Synchronizer #110
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed110 {
...
export class StatementSyncService110 {
  public static reconcile(feed: BankStatementFeed110): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
