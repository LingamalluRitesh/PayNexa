/**
 * Open Banking Data Extraction & Ledger Synchronizer #108
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed108 {
...
export class StatementSyncService108 {
  public static reconcile(feed: BankStatementFeed108): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
