/**
 * Open Banking Data Extraction & Ledger Synchronizer #183
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed183 {
...
export class StatementSyncService183 {
  public static reconcile(feed: BankStatementFeed183): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
