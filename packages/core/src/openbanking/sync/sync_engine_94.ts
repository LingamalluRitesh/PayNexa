/**
 * Open Banking Data Extraction & Ledger Synchronizer #94
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed94 {
...
export class StatementSyncService94 {
  public static reconcile(feed: BankStatementFeed94): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
