/**
 * Open Banking Data Extraction & Ledger Synchronizer #192
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed192 {
...
export class StatementSyncService192 {
  public static reconcile(feed: BankStatementFeed192): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
