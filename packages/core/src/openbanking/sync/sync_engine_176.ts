/**
 * Open Banking Data Extraction & Ledger Synchronizer #176
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed176 {
...
export class StatementSyncService176 {
  public static reconcile(feed: BankStatementFeed176): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
