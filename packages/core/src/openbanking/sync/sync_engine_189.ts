/**
 * Open Banking Data Extraction & Ledger Synchronizer #189
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed189 {
...
export class StatementSyncService189 {
  public static reconcile(feed: BankStatementFeed189): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
