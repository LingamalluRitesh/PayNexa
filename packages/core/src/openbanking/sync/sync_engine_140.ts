/**
 * Open Banking Data Extraction & Ledger Synchronizer #140
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed140 {
...
export class StatementSyncService140 {
  public static reconcile(feed: BankStatementFeed140): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
