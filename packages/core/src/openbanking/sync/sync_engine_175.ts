/**
 * Open Banking Data Extraction & Ledger Synchronizer #175
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed175 {
...
export class StatementSyncService175 {
  public static reconcile(feed: BankStatementFeed175): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
