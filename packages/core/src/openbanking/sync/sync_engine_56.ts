/**
 * Open Banking Data Extraction & Ledger Synchronizer #56
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed56 {
...
export class StatementSyncService56 {
  public static reconcile(feed: BankStatementFeed56): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
