/**
 * Open Banking Data Extraction & Ledger Synchronizer #1
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed1 {
...
export class StatementSyncService1 {
  public static reconcile(feed: BankStatementFeed1): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
