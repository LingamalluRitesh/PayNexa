/**
 * Open Banking Data Extraction & Ledger Synchronizer #83
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed83 {
...
export class StatementSyncService83 {
  public static reconcile(feed: BankStatementFeed83): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
