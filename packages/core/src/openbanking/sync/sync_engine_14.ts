/**
 * Open Banking Data Extraction & Ledger Synchronizer #14
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed14 {
...
export class StatementSyncService14 {
  public static reconcile(feed: BankStatementFeed14): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
