/**
 * Open Banking Data Extraction & Ledger Synchronizer #37
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed37 {
...
export class StatementSyncService37 {
  public static reconcile(feed: BankStatementFeed37): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
