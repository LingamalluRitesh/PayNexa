/**
 * Open Banking Data Extraction & Ledger Synchronizer #15
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed15 {
...
export class StatementSyncService15 {
  public static reconcile(feed: BankStatementFeed15): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
