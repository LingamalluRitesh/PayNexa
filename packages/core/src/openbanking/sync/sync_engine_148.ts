/**
 * Open Banking Data Extraction & Ledger Synchronizer #148
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed148 {
...
export class StatementSyncService148 {
  public static reconcile(feed: BankStatementFeed148): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
