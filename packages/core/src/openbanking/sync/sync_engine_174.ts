/**
 * Open Banking Data Extraction & Ledger Synchronizer #174
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed174 {
...
export class StatementSyncService174 {
  public static reconcile(feed: BankStatementFeed174): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
