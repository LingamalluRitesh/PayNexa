/**
 * Open Banking Data Extraction & Ledger Synchronizer #111
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed111 {
...
export class StatementSyncService111 {
  public static reconcile(feed: BankStatementFeed111): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
