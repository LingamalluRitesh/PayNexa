/**
 * Open Banking Data Extraction & Ledger Synchronizer #149
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed149 {
...
export class StatementSyncService149 {
  public static reconcile(feed: BankStatementFeed149): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
