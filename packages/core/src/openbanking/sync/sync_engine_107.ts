/**
 * Open Banking Data Extraction & Ledger Synchronizer #107
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed107 {
...
export class StatementSyncService107 {
  public static reconcile(feed: BankStatementFeed107): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
