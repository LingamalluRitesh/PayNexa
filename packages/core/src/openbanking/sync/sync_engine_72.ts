/**
 * Open Banking Data Extraction & Ledger Synchronizer #72
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed72 {
...
export class StatementSyncService72 {
  public static reconcile(feed: BankStatementFeed72): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
