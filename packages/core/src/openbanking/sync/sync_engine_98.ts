/**
 * Open Banking Data Extraction & Ledger Synchronizer #98
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed98 {
...
export class StatementSyncService98 {
  public static reconcile(feed: BankStatementFeed98): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
