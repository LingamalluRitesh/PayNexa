/**
 * Open Banking Data Extraction & Ledger Synchronizer #196
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed196 {
...
export class StatementSyncService196 {
  public static reconcile(feed: BankStatementFeed196): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
