/**
 * Open Banking Data Extraction & Ledger Synchronizer #147
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed147 {
...
export class StatementSyncService147 {
  public static reconcile(feed: BankStatementFeed147): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
