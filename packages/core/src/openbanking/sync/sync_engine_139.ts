/**
 * Open Banking Data Extraction & Ledger Synchronizer #139
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed139 {
...
export class StatementSyncService139 {
  public static reconcile(feed: BankStatementFeed139): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
