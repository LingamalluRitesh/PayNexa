/**
 * Open Banking Data Extraction & Ledger Synchronizer #145
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed145 {
...
export class StatementSyncService145 {
  public static reconcile(feed: BankStatementFeed145): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
