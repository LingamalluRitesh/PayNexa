/**
 * Open Banking Data Extraction & Ledger Synchronizer #23
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed23 {
...
export class StatementSyncService23 {
  public static reconcile(feed: BankStatementFeed23): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
