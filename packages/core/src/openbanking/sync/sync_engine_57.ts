/**
 * Open Banking Data Extraction & Ledger Synchronizer #57
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed57 {
...
export class StatementSyncService57 {
  public static reconcile(feed: BankStatementFeed57): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
