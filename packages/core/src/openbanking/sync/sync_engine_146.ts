/**
 * Open Banking Data Extraction & Ledger Synchronizer #146
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed146 {
...
export class StatementSyncService146 {
  public static reconcile(feed: BankStatementFeed146): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
