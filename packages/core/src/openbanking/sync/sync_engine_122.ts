/**
 * Open Banking Data Extraction & Ledger Synchronizer #122
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed122 {
...
export class StatementSyncService122 {
  public static reconcile(feed: BankStatementFeed122): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
