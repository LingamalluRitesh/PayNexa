/**
 * Open Banking Data Extraction & Ledger Synchronizer #198
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed198 {
...
export class StatementSyncService198 {
  public static reconcile(feed: BankStatementFeed198): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
