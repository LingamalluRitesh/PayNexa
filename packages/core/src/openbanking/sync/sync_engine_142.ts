/**
 * Open Banking Data Extraction & Ledger Synchronizer #142
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed142 {
...
export class StatementSyncService142 {
  public static reconcile(feed: BankStatementFeed142): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
