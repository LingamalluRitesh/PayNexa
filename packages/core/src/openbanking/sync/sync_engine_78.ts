/**
 * Open Banking Data Extraction & Ledger Synchronizer #78
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed78 {
...
export class StatementSyncService78 {
  public static reconcile(feed: BankStatementFeed78): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
