/**
 * Open Banking Data Extraction & Ledger Synchronizer #20
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed20 {
...
export class StatementSyncService20 {
  public static reconcile(feed: BankStatementFeed20): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
