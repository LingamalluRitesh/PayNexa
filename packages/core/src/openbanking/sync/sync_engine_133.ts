/**
 * Open Banking Data Extraction & Ledger Synchronizer #133
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed133 {
...
export class StatementSyncService133 {
  public static reconcile(feed: BankStatementFeed133): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
