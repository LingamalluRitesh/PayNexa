/**
 * Open Banking Data Extraction & Ledger Synchronizer #141
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed141 {
...
export class StatementSyncService141 {
  public static reconcile(feed: BankStatementFeed141): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
