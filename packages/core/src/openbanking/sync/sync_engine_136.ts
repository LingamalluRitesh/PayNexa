/**
 * Open Banking Data Extraction & Ledger Synchronizer #136
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed136 {
...
export class StatementSyncService136 {
  public static reconcile(feed: BankStatementFeed136): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
