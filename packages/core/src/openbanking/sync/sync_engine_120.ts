/**
 * Open Banking Data Extraction & Ledger Synchronizer #120
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed120 {
...
export class StatementSyncService120 {
  public static reconcile(feed: BankStatementFeed120): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
