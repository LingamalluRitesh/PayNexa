/**
 * Open Banking Data Extraction & Ledger Synchronizer #40
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed40 {
...
export class StatementSyncService40 {
  public static reconcile(feed: BankStatementFeed40): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
