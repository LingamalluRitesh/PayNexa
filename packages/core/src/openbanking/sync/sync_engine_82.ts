/**
 * Open Banking Data Extraction & Ledger Synchronizer #82
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed82 {
...
export class StatementSyncService82 {
  public static reconcile(feed: BankStatementFeed82): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
