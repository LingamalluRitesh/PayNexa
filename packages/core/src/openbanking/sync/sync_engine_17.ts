/**
 * Open Banking Data Extraction & Ledger Synchronizer #17
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed17 {
...
export class StatementSyncService17 {
  public static reconcile(feed: BankStatementFeed17): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
