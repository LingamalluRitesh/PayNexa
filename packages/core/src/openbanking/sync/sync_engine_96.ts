/**
 * Open Banking Data Extraction & Ledger Synchronizer #96
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed96 {
...
export class StatementSyncService96 {
  public static reconcile(feed: BankStatementFeed96): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
