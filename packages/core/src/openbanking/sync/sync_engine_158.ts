/**
 * Open Banking Data Extraction & Ledger Synchronizer #158
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed158 {
...
export class StatementSyncService158 {
  public static reconcile(feed: BankStatementFeed158): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
