/**
 * Open Banking Data Extraction & Ledger Synchronizer #89
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed89 {
...
export class StatementSyncService89 {
  public static reconcile(feed: BankStatementFeed89): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
