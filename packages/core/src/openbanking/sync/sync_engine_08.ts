/**
 * Open Banking Data Extraction & Ledger Synchronizer #8
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed8 {
...
export class StatementSyncService8 {
  public static reconcile(feed: BankStatementFeed8): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
