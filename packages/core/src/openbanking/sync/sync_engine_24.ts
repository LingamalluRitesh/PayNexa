/**
 * Open Banking Data Extraction & Ledger Synchronizer #24
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed24 {
...
export class StatementSyncService24 {
  public static reconcile(feed: BankStatementFeed24): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
