/**
 * Open Banking Data Extraction & Ledger Synchronizer #92
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed92 {
...
export class StatementSyncService92 {
  public static reconcile(feed: BankStatementFeed92): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
