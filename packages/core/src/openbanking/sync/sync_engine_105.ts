/**
 * Open Banking Data Extraction & Ledger Synchronizer #105
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed105 {
...
export class StatementSyncService105 {
  public static reconcile(feed: BankStatementFeed105): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
