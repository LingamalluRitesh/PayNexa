/**
 * Open Banking Data Extraction & Ledger Synchronizer #73
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed73 {
...
export class StatementSyncService73 {
  public static reconcile(feed: BankStatementFeed73): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
