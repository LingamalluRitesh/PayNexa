/**
 * Open Banking Data Extraction & Ledger Synchronizer #173
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed173 {
...
export class StatementSyncService173 {
  public static reconcile(feed: BankStatementFeed173): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
