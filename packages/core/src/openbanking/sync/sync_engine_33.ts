/**
 * Open Banking Data Extraction & Ledger Synchronizer #33
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed33 {
...
export class StatementSyncService33 {
  public static reconcile(feed: BankStatementFeed33): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
