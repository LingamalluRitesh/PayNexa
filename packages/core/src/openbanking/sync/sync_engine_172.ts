/**
 * Open Banking Data Extraction & Ledger Synchronizer #172
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed172 {
...
export class StatementSyncService172 {
  public static reconcile(feed: BankStatementFeed172): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
