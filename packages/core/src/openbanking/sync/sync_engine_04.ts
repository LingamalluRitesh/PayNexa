/**
 * Open Banking Data Extraction & Ledger Synchronizer #4
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed4 {
...
export class StatementSyncService4 {
  public static reconcile(feed: BankStatementFeed4): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
