/**
 * Open Banking Data Extraction & Ledger Synchronizer #104
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed104 {
...
export class StatementSyncService104 {
  public static reconcile(feed: BankStatementFeed104): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
