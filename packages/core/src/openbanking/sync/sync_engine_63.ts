/**
 * Open Banking Data Extraction & Ledger Synchronizer #63
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed63 {
...
export class StatementSyncService63 {
  public static reconcile(feed: BankStatementFeed63): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
