/**
 * Open Banking Data Extraction & Ledger Synchronizer #25
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed25 {
...
export class StatementSyncService25 {
  public static reconcile(feed: BankStatementFeed25): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
