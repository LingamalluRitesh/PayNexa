/**
 * Open Banking Data Extraction & Ledger Synchronizer #84
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed84 {
...
export class StatementSyncService84 {
  public static reconcile(feed: BankStatementFeed84): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
