/**
 * Open Banking Data Extraction & Ledger Synchronizer #156
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed156 {
...
export class StatementSyncService156 {
  public static reconcile(feed: BankStatementFeed156): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
