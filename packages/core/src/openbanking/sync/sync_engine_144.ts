/**
 * Open Banking Data Extraction & Ledger Synchronizer #144
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed144 {
...
export class StatementSyncService144 {
  public static reconcile(feed: BankStatementFeed144): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
