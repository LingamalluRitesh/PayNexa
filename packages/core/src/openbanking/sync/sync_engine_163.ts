/**
 * Open Banking Data Extraction & Ledger Synchronizer #163
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed163 {
...
export class StatementSyncService163 {
  public static reconcile(feed: BankStatementFeed163): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
