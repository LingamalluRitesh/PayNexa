/**
 * Open Banking Data Extraction & Ledger Synchronizer #181
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed181 {
...
export class StatementSyncService181 {
  public static reconcile(feed: BankStatementFeed181): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
