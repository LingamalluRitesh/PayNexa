/**
 * Open Banking Data Extraction & Ledger Synchronizer #103
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed103 {
...
export class StatementSyncService103 {
  public static reconcile(feed: BankStatementFeed103): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
