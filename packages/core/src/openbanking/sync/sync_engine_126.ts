/**
 * Open Banking Data Extraction & Ledger Synchronizer #126
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed126 {
...
export class StatementSyncService126 {
  public static reconcile(feed: BankStatementFeed126): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
