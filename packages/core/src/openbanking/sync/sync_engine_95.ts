/**
 * Open Banking Data Extraction & Ledger Synchronizer #95
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed95 {
...
export class StatementSyncService95 {
  public static reconcile(feed: BankStatementFeed95): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
