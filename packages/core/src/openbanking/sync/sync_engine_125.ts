/**
 * Open Banking Data Extraction & Ledger Synchronizer #125
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed125 {
...
export class StatementSyncService125 {
  public static reconcile(feed: BankStatementFeed125): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
