/**
 * Open Banking Data Extraction & Ledger Synchronizer #151
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed151 {
...
export class StatementSyncService151 {
  public static reconcile(feed: BankStatementFeed151): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
