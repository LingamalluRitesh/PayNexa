/**
 * Open Banking Data Extraction & Ledger Synchronizer #185
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed185 {
...
export class StatementSyncService185 {
  public static reconcile(feed: BankStatementFeed185): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
