/**
 * Open Banking Data Extraction & Ledger Synchronizer #70
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed70 {
...
export class StatementSyncService70 {
  public static reconcile(feed: BankStatementFeed70): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
