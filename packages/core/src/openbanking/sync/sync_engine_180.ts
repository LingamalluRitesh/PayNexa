/**
 * Open Banking Data Extraction & Ledger Synchronizer #180
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed180 {
...
export class StatementSyncService180 {
  public static reconcile(feed: BankStatementFeed180): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
