/**
 * Open Banking Data Extraction & Ledger Synchronizer #116
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed116 {
...
export class StatementSyncService116 {
  public static reconcile(feed: BankStatementFeed116): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
