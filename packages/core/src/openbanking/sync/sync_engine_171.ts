/**
 * Open Banking Data Extraction & Ledger Synchronizer #171
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed171 {
...
export class StatementSyncService171 {
  public static reconcile(feed: BankStatementFeed171): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
