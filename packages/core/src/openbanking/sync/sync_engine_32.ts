/**
 * Open Banking Data Extraction & Ledger Synchronizer #32
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed32 {
...
export class StatementSyncService32 {
  public static reconcile(feed: BankStatementFeed32): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
