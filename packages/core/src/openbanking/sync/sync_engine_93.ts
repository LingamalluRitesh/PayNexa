/**
 * Open Banking Data Extraction & Ledger Synchronizer #93
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed93 {
...
export class StatementSyncService93 {
  public static reconcile(feed: BankStatementFeed93): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
