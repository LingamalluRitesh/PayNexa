/**
 * Open Banking Data Extraction & Ledger Synchronizer #80
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed80 {
...
export class StatementSyncService80 {
  public static reconcile(feed: BankStatementFeed80): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
