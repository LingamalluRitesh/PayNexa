/**
 * Open Banking Data Extraction & Ledger Synchronizer #165
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed165 {
...
export class StatementSyncService165 {
  public static reconcile(feed: BankStatementFeed165): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
