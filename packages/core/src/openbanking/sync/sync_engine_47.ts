/**
 * Open Banking Data Extraction & Ledger Synchronizer #47
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed47 {
...
export class StatementSyncService47 {
  public static reconcile(feed: BankStatementFeed47): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
