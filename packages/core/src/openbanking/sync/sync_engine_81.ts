/**
 * Open Banking Data Extraction & Ledger Synchronizer #81
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed81 {
...
export class StatementSyncService81 {
  public static reconcile(feed: BankStatementFeed81): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
