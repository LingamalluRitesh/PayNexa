/**
 * Open Banking Data Extraction & Ledger Synchronizer #118
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed118 {
...
export class StatementSyncService118 {
  public static reconcile(feed: BankStatementFeed118): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
