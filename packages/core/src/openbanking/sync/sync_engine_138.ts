/**
 * Open Banking Data Extraction & Ledger Synchronizer #138
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed138 {
...
export class StatementSyncService138 {
  public static reconcile(feed: BankStatementFeed138): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
