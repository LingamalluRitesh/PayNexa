/**
 * Open Banking Data Extraction & Ledger Synchronizer #191
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed191 {
...
export class StatementSyncService191 {
  public static reconcile(feed: BankStatementFeed191): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
