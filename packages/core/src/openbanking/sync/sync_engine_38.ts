/**
 * Open Banking Data Extraction & Ledger Synchronizer #38
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed38 {
...
export class StatementSyncService38 {
  public static reconcile(feed: BankStatementFeed38): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
