/**
 * Open Banking Data Extraction & Ledger Synchronizer #157
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed157 {
...
export class StatementSyncService157 {
  public static reconcile(feed: BankStatementFeed157): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
