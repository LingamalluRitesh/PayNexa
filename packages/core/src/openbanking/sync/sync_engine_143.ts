/**
 * Open Banking Data Extraction & Ledger Synchronizer #143
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed143 {
...
export class StatementSyncService143 {
  public static reconcile(feed: BankStatementFeed143): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
