/**
 * Open Banking Data Extraction & Ledger Synchronizer #154
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed154 {
...
export class StatementSyncService154 {
  public static reconcile(feed: BankStatementFeed154): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
