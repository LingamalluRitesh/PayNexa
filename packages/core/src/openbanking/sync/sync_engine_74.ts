/**
 * Open Banking Data Extraction & Ledger Synchronizer #74
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed74 {
...
export class StatementSyncService74 {
  public static reconcile(feed: BankStatementFeed74): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
