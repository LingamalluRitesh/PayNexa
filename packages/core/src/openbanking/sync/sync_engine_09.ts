/**
 * Open Banking Data Extraction & Ledger Synchronizer #9
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed9 {
...
export class StatementSyncService9 {
  public static reconcile(feed: BankStatementFeed9): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
