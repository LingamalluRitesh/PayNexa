/**
 * Open Banking Data Extraction & Ledger Synchronizer #160
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed160 {
...
export class StatementSyncService160 {
  public static reconcile(feed: BankStatementFeed160): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
