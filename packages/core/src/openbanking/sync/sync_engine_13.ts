/**
 * Open Banking Data Extraction & Ledger Synchronizer #13
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed13 {
...
export class StatementSyncService13 {
  public static reconcile(feed: BankStatementFeed13): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
