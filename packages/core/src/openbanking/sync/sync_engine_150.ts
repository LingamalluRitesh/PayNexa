/**
 * Open Banking Data Extraction & Ledger Synchronizer #150
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed150 {
...
export class StatementSyncService150 {
  public static reconcile(feed: BankStatementFeed150): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
