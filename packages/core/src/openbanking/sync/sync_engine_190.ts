/**
 * Open Banking Data Extraction & Ledger Synchronizer #190
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed190 {
...
export class StatementSyncService190 {
  public static reconcile(feed: BankStatementFeed190): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
