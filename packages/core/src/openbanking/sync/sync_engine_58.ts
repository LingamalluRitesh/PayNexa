/**
 * Open Banking Data Extraction & Ledger Synchronizer #58
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed58 {
...
export class StatementSyncService58 {
  public static reconcile(feed: BankStatementFeed58): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
