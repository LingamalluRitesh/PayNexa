/**
 * Open Banking Data Extraction & Ledger Synchronizer #112
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed112 {
...
export class StatementSyncService112 {
  public static reconcile(feed: BankStatementFeed112): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
