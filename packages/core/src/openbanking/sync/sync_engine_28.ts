/**
 * Open Banking Data Extraction & Ledger Synchronizer #28
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed28 {
...
export class StatementSyncService28 {
  public static reconcile(feed: BankStatementFeed28): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
