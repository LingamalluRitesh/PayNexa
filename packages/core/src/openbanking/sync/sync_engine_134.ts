/**
 * Open Banking Data Extraction & Ledger Synchronizer #134
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed134 {
...
export class StatementSyncService134 {
  public static reconcile(feed: BankStatementFeed134): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
