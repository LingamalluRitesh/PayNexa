/**
 * Open Banking Data Extraction & Ledger Synchronizer #60
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed60 {
...
export class StatementSyncService60 {
  public static reconcile(feed: BankStatementFeed60): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
