/**
 * Open Banking Data Extraction & Ledger Synchronizer #67
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed67 {
...
export class StatementSyncService67 {
  public static reconcile(feed: BankStatementFeed67): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
