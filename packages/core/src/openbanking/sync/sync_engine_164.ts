/**
 * Open Banking Data Extraction & Ledger Synchronizer #164
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed164 {
...
export class StatementSyncService164 {
  public static reconcile(feed: BankStatementFeed164): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
