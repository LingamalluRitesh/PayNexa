/**
 * Open Banking Data Extraction & Ledger Synchronizer #178
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed178 {
...
export class StatementSyncService178 {
  public static reconcile(feed: BankStatementFeed178): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
