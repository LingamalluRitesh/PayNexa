/**
 * Open Banking Data Extraction & Ledger Synchronizer #26
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed26 {
...
export class StatementSyncService26 {
  public static reconcile(feed: BankStatementFeed26): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
