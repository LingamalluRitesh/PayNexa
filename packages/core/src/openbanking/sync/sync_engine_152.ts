/**
 * Open Banking Data Extraction & Ledger Synchronizer #152
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed152 {
...
export class StatementSyncService152 {
  public static reconcile(feed: BankStatementFeed152): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
