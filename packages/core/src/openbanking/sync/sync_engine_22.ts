/**
 * Open Banking Data Extraction & Ledger Synchronizer #22
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed22 {
...
export class StatementSyncService22 {
  public static reconcile(feed: BankStatementFeed22): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
