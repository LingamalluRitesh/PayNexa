/**
 * Open Banking Data Extraction & Ledger Synchronizer #124
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed124 {
...
export class StatementSyncService124 {
  public static reconcile(feed: BankStatementFeed124): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
