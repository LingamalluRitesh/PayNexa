/**
 * Open Banking Data Extraction & Ledger Synchronizer #113
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed113 {
...
export class StatementSyncService113 {
  public static reconcile(feed: BankStatementFeed113): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
