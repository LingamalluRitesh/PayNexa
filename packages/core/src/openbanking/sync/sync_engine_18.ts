/**
 * Open Banking Data Extraction & Ledger Synchronizer #18
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed18 {
...
export class StatementSyncService18 {
  public static reconcile(feed: BankStatementFeed18): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
