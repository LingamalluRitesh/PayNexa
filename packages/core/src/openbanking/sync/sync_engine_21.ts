/**
 * Open Banking Data Extraction & Ledger Synchronizer #21
 * Open Banking Read/Write API Profile v3.1.10 Reconciliation
 */

export interface BankStatementFeed21 {
...
export class StatementSyncService21 {
  public static reconcile(feed: BankStatementFeed21): { isBalanced: boolean; totalDebits: number; totalCredits: number } {
    let totalDebits = 0;
    let totalCredits = 0;
