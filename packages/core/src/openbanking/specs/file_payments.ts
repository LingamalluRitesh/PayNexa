/**
 * Open Banking UK & Berlin Group PSD2 Specification: OBWriteFile2
 * Description: Bulk File Payment Consents and Submissions for corporate payroll
 * Compliant with Open Banking Standard v3.1.10 & NextGenPSD2 v1.3.6
 */

export interface OBWriteFile2Request {
  data: {
    consentId?: string;
...
export interface OBWriteFile2Response {
  data: {
    resourceId: string;
    consentId: string;
...
export class OBWriteFile2Handler {
  public static validateConsent(req: OBWriteFile2Request): boolean {
