/**
 * Open Banking UK & Berlin Group PSD2 Specification: OBWriteInternationalScheduled3
 * Description: International Scheduled Payment Consents and Submissions
 * Compliant with Open Banking Standard v3.1.10 & NextGenPSD2 v1.3.6
 */

export interface OBWriteInternationalScheduled3Request {
  data: {
    consentId?: string;
...
export interface OBWriteInternationalScheduled3Response {
  data: {
    resourceId: string;
    consentId: string;
...
export class OBWriteInternationalScheduled3Handler {
  public static validateConsent(req: OBWriteInternationalScheduled3Request): boolean {
