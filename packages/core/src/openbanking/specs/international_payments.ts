/**
 * Open Banking UK & Berlin Group PSD2 Specification: OBWriteInternational3
 * Description: Cross-Border International Payment Consents and Submissions
 * Compliant with Open Banking Standard v3.1.10 & NextGenPSD2 v1.3.6
 */

export interface OBWriteInternational3Request {
  data: {
    consentId?: string;
...
export interface OBWriteInternational3Response {
  data: {
    resourceId: string;
    consentId: string;
...
export class OBWriteInternational3Handler {
  public static validateConsent(req: OBWriteInternational3Request): boolean {
