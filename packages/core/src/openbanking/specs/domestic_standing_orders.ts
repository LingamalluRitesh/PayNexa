/**
 * Open Banking UK & Berlin Group PSD2 Specification: OBWriteDomesticStandingOrder3
 * Description: Domestic Standing Order Recurring Consents and Submissions
 * Compliant with Open Banking Standard v3.1.10 & NextGenPSD2 v1.3.6
 */

export interface OBWriteDomesticStandingOrder3Request {
  data: {
    consentId?: string;
...
export interface OBWriteDomesticStandingOrder3Response {
  data: {
    resourceId: string;
    consentId: string;
...
export class OBWriteDomesticStandingOrder3Handler {
  public static validateConsent(req: OBWriteDomesticStandingOrder3Request): boolean {
